# GCP STG Environment Configuration
...
app_namespace = "stg-mcp-server-langgraph"

# Monitoring (no channels configured yet)
monitoring_notification_channels = []

# Security (disabled for stg to allow easy access)
...
# Deletion protection (disabled for stg to allow teardown)
