...
- Supports multiple environments (dev, stg, production)
...
module "secrets" {
  ...
  external_secrets_service_account = "external-secrets-stg@vishnu-sandbox-20250310.iam.gserviceaccount.com"
...
# Import each secret
terraform import 'module.secrets.google_secret_manager_secret.secrets["stg-anthropic-api-key"]' \
  projects/vishnu-sandbox-20250310/secrets/stg-anthropic-api-key

terraform import 'module.secrets.google_secret_manager_secret.secrets["stg-jwt-secret"]' \
  projects/vishnu-sandbox-20250310/secrets/stg-jwt-secret

# Import IAM bindings
terraform import 'module.secrets.google_secret_manager_secret_iam_member.external_secrets["stg-anthropic-api-key"]' \
  "projects/vishnu-sandbox-20250310/secrets/stg-anthropic-api-key roles/secretmanager.secretAccessor serviceAccount:external-secrets-stg@vishnu-sandbox-20250310.iam.gserviceaccount.com"
...
echo -n "your-secret-value" | gcloud secrets versions add stg-anthropic-api-key \
  --data-file=- \
  --project=vishnu-sandbox-20250310

# Or from file
gcloud secrets versions add stg-jwt-secret \
