...
4. **Loki ruler tenant directory**: With `auth_enabled: false`, rules must be under `${TMPDIR:-/tmp}/loki/rules/fake/` (the "fake" tenant). Mount rules like: `./docker/loki/rules:${TMPDIR:-/tmp}/loki/rules/fake:ro`
