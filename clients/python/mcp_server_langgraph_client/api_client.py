...
import mcp_server_langgraph_client.models
from mcp_server_langgraph_client import rest
from mcp_server_langgraph_client.api_response import ApiResponse
from mcp_server_langgraph_client.api_response import T as ApiResponseT
from mcp_server_langgraph_client.configuration import Configuration
from mcp_server_langgraph_client.exceptions import (
    ApiException,
    ApiValueError,
)
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        return ApiResponse(
            status_code=response_data.status, data=return_data, headers=response_data.getheaders(), raw_data=response_data.data
        )
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mcp_server_langgraph_client.models, klass)
