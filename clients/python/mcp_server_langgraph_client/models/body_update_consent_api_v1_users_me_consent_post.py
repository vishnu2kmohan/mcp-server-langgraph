...
class BodyUpdateConsentApiV1UsersMeConsentPost(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["consent", "credentials"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consent": ConsentRecord.from_dict(obj["consent"]) if obj.get("consent") is not None else None,
