...
class UserProfileUpdate(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] | None = None
    email: StrictStr | None = None
    preferences: dict[str, Any] | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["name", "email", "preferences"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"name": obj.get("name"), "email": obj.get("email"), "preferences": obj.get("preferences")})
