...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("mcp_server_langgraph_client")
    ...
    def get_host_from_settings(
        ...
        try:
            ...
            raise ValueError(f"Invalid index {index} when selecting the host settings. " f"Must be less than {len(servers)}")
