...
class CreateAPIKeyResponse(BaseModel):
    ...
    message: StrictStr | None = "API key created successfully. Save it securely - it will not be shown again."
        ...
        _obj = cls.model_validate(
            {
                ...
                "message": (
                    ...
                    else "API key created successfully. Save it securely - it will not be shown again."
                ),
            }
        )
        return _obj
