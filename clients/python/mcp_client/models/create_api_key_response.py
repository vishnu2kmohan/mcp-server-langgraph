...
class CreateAPIKeyResponse(BaseModel):
    ...
    api_key: StrictStr = Field(description="API key (save securely, won't be shown again)")
    message: Optional[StrictStr] = 'API key created successfully. Save it securely - it will not be shown again.'
    __properties: ClassVar[List[str]] = ["key_id", "name", "created", "expires_at", "last_used", "api_key", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "message": obj.get("message") if obj.get("message") is not None else 'API key created successfully. Save it securely - it will not be shown again.'
        })
        return _obj
