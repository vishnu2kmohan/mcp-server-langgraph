...
class BodyUpdateUserScimV2UsersUserIdPatch(BaseModel):
    """
    BodyUpdateUserScimV2UsersUserIdPatch
    """ # noqa: E501
    patch_request: SCIMPatchRequest
    credentials: Optional[HTTPAuthorizationCredentials] = None
    __properties: ClassVar[List[str]] = ["patch_request", "credentials"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of patch_request
        if self.patch_request:
            _dict['patch_request'] = self.patch_request.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patch_request": SCIMPatchRequest.from_dict(obj["patch_request"]) if obj.get("patch_request") is not None else None,
