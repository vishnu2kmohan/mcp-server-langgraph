...
class SCIMUser(BaseModel):
    ...
    schemas: list[StrictStr | None] | None = None
    ...
    profile_url: StrictStr | None = Field(default=None, alias="profileUrl")
    title: StrictStr | None = None
    user_type: StrictStr | None = Field(default=None, alias="userType")
    preferred_language: StrictStr | None = Field(default=None, alias="preferredLanguage")
    locale: StrictStr | None = None
    timezone: StrictStr | None = None
    active: StrictBool | None = True
    password: StrictStr | None = None
    emails: list[SCIMEmail] | None = None
    phone_numbers: list[SCIMPhoneNumber] | None = Field(default=None, alias="phoneNumbers")
    addresses: list[SCIMAddress] | None = None
    groups: list[SCIMGroupMembership] | None = None
    meta: dict[str, Any] | None = None
    urn_ietf_params_scim_schemas_extension_enterprise_2_0_user: SCIMEnterpriseUser | None = Field(
        default=None, alias="urn:ietf:params:scim:schemas:extension:enterprise:2.0:User"
    )
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.urn_ietf_params_scim_schemas_extension_enterprise_2_0_user:
            _dict["urn:ietf:params:scim:schemas:extension:enterprise:2.0:User"] = (
                self.urn_ietf_params_scim_schemas_extension_enterprise_2_0_user.to_dict()
            )
        ...
        # and model_fields_set contains the field
        if (
            self.urn_ietf_params_scim_schemas_extension_enterprise_2_0_user is None
            and "urn_ietf_params_scim_schemas_extension_enterprise_2_0_user" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "phoneNumbers": (
                    [SCIMPhoneNumber.from_dict(_item) for _item in obj["phoneNumbers"]]
                    if obj.get("phoneNumbers") is not None
                    else None
                ),
                "addresses": (
                    [SCIMAddress.from_dict(_item) for _item in obj["addresses"]] if obj.get("addresses") is not None else None
                ),
                "groups": (
                    [SCIMGroupMembership.from_dict(_item) for _item in obj["groups"]]
                    if obj.get("groups") is not None
                    else None
                ),
                "meta": obj.get("meta"),
                "urn:ietf:params:scim:schemas:extension:enterprise:2.0:User": (
                    SCIMEnterpriseUser.from_dict(obj["urn:ietf:params:scim:schemas:extension:enterprise:2.0:User"])
