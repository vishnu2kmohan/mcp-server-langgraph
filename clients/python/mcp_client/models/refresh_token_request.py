...
class RefreshTokenRequest(BaseModel):
    ...
    current_token: Optional[StrictStr] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if current_token (nullable) is None
        # and model_fields_set contains the field
        if self.current_token is None and "current_token" in self.model_fields_set:
            _dict["current_token"] = None
