...
class APIMetadataApi:
    ...
    def get_api_version_metadata(
        ...
        _param = self._get_api_version_metadata_serialize(
    ...
    @validate_call
    def get_api_version_metadata_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_api_version_metadata_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_api_version_metadata_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
