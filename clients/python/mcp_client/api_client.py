...
from mcp_client import rest
from mcp_client.api_response import ApiResponse
from mcp_client.api_response import T as ApiResponseT
from mcp_client.configuration import Configuration
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(mcp_client.models, klass)
