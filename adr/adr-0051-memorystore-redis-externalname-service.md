...
deployments/overlays/stg-gke/redis-session-service-patch.yaml
deployments/overlays/prod-gke/redis-session-service-patch.yaml
```
...
- **Implementation:** `deployments/overlays/stg-gke/redis-session-service-patch.yaml`
