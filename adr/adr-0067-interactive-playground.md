...
- [ADR-0047: Visual Workflow Builder](adr-0047-visual-workflow-builder.md) - Complementary visual tool
- [ADR-0006: Session Storage Architecture](adr-0006-session-storage-architecture.md) - Session design patterns
- [ADR-0019: Async-First Architecture](adr-0019-async-first-architecture.md) - Async patterns used
