...
def test_otel_deployment_has_pod_security_context(project_root):
    """
    ...
    """
    deployment_file = project_root / "deployments" / "base" / "otel-collector-deployment.yaml"
...
def test_otel_deployment_has_container_security_context(project_root):
    """
...
def test_otel_has_readonly_root_filesystem(project_root):
    """
...
def test_otel_runs_as_nonroot(project_root):
    """
...
def test_otel_has_tmpfs_volumes(project_root):
    """
...
def test_otel_drops_all_capabilities(project_root):
    """
...
def test_rendered_staging_manifest_has_otel_security_context(project_root):
    """
