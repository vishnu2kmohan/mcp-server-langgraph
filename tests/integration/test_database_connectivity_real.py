...
@pytest.mark.asyncio
async def test_check_database_connectivity_with_real_postgres():
    """
...
@pytest.mark.asyncio
async def test_create_connection_pool_with_real_postgres():
    """
...
@pytest.mark.asyncio
async def test_check_database_connectivity_with_invalid_credentials():
    """
    ...
    postgres_url = "postgresql://invalid_user:invalid_pass@localhost:5432/gdpr"
...
@pytest.mark.asyncio
async def test_check_database_connectivity_with_nonexistent_database():
    """
    ...
    postgres_url = "postgresql://postgres:postgres@localhost:5432/nonexistent_db"
...
@pytest.mark.asyncio
async def test_check_database_connectivity_timeout():
    """
    ...
    # Use unreachable host (blackhole)
    postgres_url = "postgresql://postgres:postgres@192.0.2.1:5432/gdpr"
