...
@pytest.mark.asyncio
async def test_gdpr_schema_tables_exist_before_tests(integration_test_env):
    """
...
@pytest.mark.asyncio
async def test_gdpr_schema_indexes_exist(integration_test_env):
    """
...
@pytest.mark.asyncio
async def test_schema_initialization_timing(integration_test_env):
    """
...
@pytest.mark.asyncio
async def test_connection_pool_isolation(integration_test_env):
    """
...
@pytest.mark.asyncio
async def test_worker_schema_isolation(integration_test_env):
    """
...
@pytest.mark.asyncio
async def test_no_duplicate_schema_initialization(integration_test_env):
    """
