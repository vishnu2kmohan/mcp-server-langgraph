...
class TestGDPREndpoints:
    ...
    def test_client(self, mock_current_user):
        ...
        **pytest-xdist Isolation:**
        ...
        mock_gdpr_storage.user_profiles = AsyncMock()  # async-mock-configured
        mock_gdpr_storage.user_profiles.get.return_value = None  # Return None, handler will create default

        mock_gdpr_storage.preferences = AsyncMock()  # async-mock-configured
        mock_gdpr_storage.preferences.get.return_value = None  # Return None, handler will return empty dict

        mock_gdpr_storage.conversations = AsyncMock()  # async-mock-configured
        ...
        mock_gdpr_storage.consents = AsyncMock()  # async-mock-configured
        ...
        # Mock audit logs
        mock_gdpr_storage.audit_logs = AsyncMock()  # async-mock-configured
