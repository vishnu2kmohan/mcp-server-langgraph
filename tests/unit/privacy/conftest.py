"""
Pytest fixtures for unit privacy tests.

Enables PII tokenization feature flag required for testing PII
detection and tokenization functionality.
"""
...
def enable_pii_tokenization_for_privacy_tests(monkeypatch: pytest.MonkeyPatch) -> None:
    """Enable PII tokenization feature flag for all unit privacy tests.
    ...
    but must be enabled for testing the privacy module.
    """
