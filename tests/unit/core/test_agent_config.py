...
class TestSemanticToolSelectionConfig:
    ...
    def test_enable_semantic_tool_search_default_false(self):
        """enable_semantic_tool_search should default to False."""
        from mcp_server_langgraph.core.agent_config import AgentConfig
        ...
        assert config.enable_semantic_tool_search is False
    ...
    def test_enable_semantic_tool_search_is_topology_field(self):
        """enable_semantic_tool_search should affect graph topology."""
        from mcp_server_langgraph.core.agent_config import AgentConfig

        config = AgentConfig()

        # Should be in topology fields (adds retrieve_tools node)
