...
class TestGetTokenValidator:
    ...
    def test_returns_none_when_auth_provider_not_keycloak(self):
        ...
        with patch(
            "mcp_server_langgraph.core.dependencies.settings"
        ) as mock_settings:
    ...
    def test_returns_token_validator_when_auth_provider_is_keycloak(self):
        ...
        with (
            ...
            patch(
                "mcp_server_langgraph.core.dependencies.TokenValidator"
            ) as MockValidator,
        ):
...
class TestGetOpenfgaClient:
    ...
    def test_returns_client_when_store_id_is_set(self):
        ...
        with (
            ...
            patch(
                "mcp_server_langgraph.core.dependencies.OpenFGAClient"
            ) as MockClient,
        ):
    ...
    def test_logs_warning_when_no_store_config(self):
        ...
        with patch(
            ...
            with patch(
                "mcp_server_langgraph.observability.telemetry.logger"
            ) as mock_logger:
                # WHEN: get_openfga_client is called
...
class TestGetMcpClient:
    ...
    def test_returns_mcp_client_instance(self):
        ...
        # GIVEN: Default state
        with patch(
            "mcp_server_langgraph.core.dependencies.MCPClient"
        ) as MockClient:
            mock_client_instance = MagicMock()
            MockClient.return_value = mock_client_instance
...
class TestGetOauth2Service:
    ...
    def test_returns_oauth2_service_instance(self):
        ...
        # GIVEN: Default state
        with patch(
            "mcp_server_langgraph.core.dependencies.OAuth2Service"
        ) as MockService:
