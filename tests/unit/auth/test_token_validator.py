...
class TestTokenValidatorBasicVerification:
    ...
    async def test_verify_token_delegates_to_user_provider(self) -> None:
        ...
        mock_provider = AsyncMock(return_value=None)  # async-mock-configured (return_value set below)
    ...
    async def test_verify_token_checks_denylist(self) -> None:
        ...
        mock_denylist = AsyncMock(return_value=None)  # async-mock-configured (return_value set below)
