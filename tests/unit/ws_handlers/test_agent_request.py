...
def mock_hitl_broadcaster() -> MagicMock:
    ...
    broadcaster.connect = AsyncMock(return_value=None)  # noqa: async-mock-config
    broadcaster.disconnect = MagicMock()
    broadcaster.broadcast = AsyncMock(return_value=None)  # noqa: async-mock-config
    broadcaster.send_to_session = AsyncMock(return_value=None)  # noqa: async-mock-config
    return broadcaster
