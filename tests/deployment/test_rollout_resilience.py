...
PREVIEW_GKE_OVERLAY = REPO_ROOT / "deployments" / "overlays" / "stg-gke"
DEPLOY_WORKFLOW_PATH = REPO_ROOT / ".github" / "workflows" / "deploy-stg-gke.yaml"
...
def _load_workflow() -> dict[str, Any]:
    """Load the deploy-stg-gke workflow."""
...
class TestCIWorkflowDeployment:
    ...
    def test_workflow_has_pre_deployment_cleanup(self) -> None:
        ...
        deploy_job = workflow.get("jobs", {}).get("deploy-stg", {})
        ...
        assert cleanup_step_found, (
            "Missing pre-deployment cleanup step in deploy-stg-gke.yaml.\n"
