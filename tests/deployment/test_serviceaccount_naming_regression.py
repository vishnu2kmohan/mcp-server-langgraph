...
- Run #19311976718: ServiceAccount 'stg-openfga-sa' missing annotation
...
STAGING_OVERLAY = REPO_ROOT / "deployments" / "overlays" / "stg-gke"
PRODUCTION_OVERLAY = REPO_ROOT / "deployments" / "overlays" / "prod-gke"
...
class TestOverlayServiceAccountNaming:
    ...
    def test_staging_openfga_serviceaccount_has_sa_suffix(self):
        ...
        not 'openfga'. After kustomization patches, it becomes 'stg-openfga-sa'.
        """
    ...
    def test_staging_keycloak_serviceaccount_has_sa_suffix(self):
        ...
        not 'keycloak'. After kustomization patches, it becomes 'stg-keycloak-sa'.
        """
