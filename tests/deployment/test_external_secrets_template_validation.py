...
class TestExternalSecretsRedisURLEncoding:
    ...
    def staging_external_secrets_path(self) -> Path:
        ...
        return Path("deployments/overlays/stg-gke/external-secrets.yaml")
...
class TestExternalSecretsRegressionPrevention:
    ...
    def template_content(self) -> str:
        ...
        path = Path("deployments/overlays/stg-gke/external-secrets.yaml")
        if not path.exists():
...
class TestExternalSecretsMultiEnvironmentConsistency:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # "deployments/overlays/prod-gke/external-secrets.yaml",
        ],
    )
