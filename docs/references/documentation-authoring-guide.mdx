...
Reference? → docs/references/your-reference.mdx
```
...
✅ [Icon Guide](/references/icon-selection-guide)
...
See [Icon Selection Guide](/references/icon-selection-guide) for comprehensive icon reference.
...
- **Prefer Mermaid** for diagrams (see [Mermaid Guide](/references/mermaid-guide))
...
- **Icon reference**: [Icon Selection Guide](/references/icon-selection-guide)
- **Mermaid diagrams**: [Mermaid Guide](/references/mermaid-guide)
