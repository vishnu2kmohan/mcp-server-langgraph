...
<Steps>
  ...
  <Step title="Container Registry">
    ...
    ```bash
    # Build image
    docker build -t gcr.io/your-project/langgraph-agent:v2.4.0 .

    # Push to registry
    docker push gcr.io/your-project/langgraph-agent:v2.4.0
    ```
      ...
      template:
        spec:
          ...
          - name: langgraph-agent
            image: gcr.io/your-project/langgraph-agent:v2.4.0
    ```
  </Step>
