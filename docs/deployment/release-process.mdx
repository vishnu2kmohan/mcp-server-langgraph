...
For automated deployments to stg/production:
...
**Example**: `.github/workflows/deploy-stg.yaml`
...
1. **Always test releases in stg first**
...
7. **Automate deployment to stg**, manual to production
