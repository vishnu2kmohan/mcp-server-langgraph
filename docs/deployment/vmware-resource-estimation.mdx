...
icon: 'rocket'
seoTitle: "VMware VM Resource Estimation for MCP Server LangG - Deployment Guide"
seoDescription: "Deploy MCP Server: Target Platform: VMware vSphere / ESXi 1. [Executive Summary](#executive-summary) 2. [Component Resource Requirements](#component-resou"
...
- No autoscaling
- Minimal monitoring
- Suitable for developers and stg environments
...
If running multiple environments (dev, stg, prod):
...
3. **Deploy Application:**
   ...
   - Or Kustomize: `kubectl apply -k deployments/kubernetes/overlays/prod`
