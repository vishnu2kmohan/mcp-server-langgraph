...
<CardGroup cols={3}>
  ...
  <Card title="Kubernetes" icon="layers" href="/deployment/kubernetes">
  ...
  <Card title="Helm" icon="boxes" href="/deployment/helm">
...
<CardGroup cols={2}>
  ...
  <Card title="Kubernetes Setup" icon="layers" href="/deployment/kubernetes">
