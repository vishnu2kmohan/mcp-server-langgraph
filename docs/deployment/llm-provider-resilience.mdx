...
|-------|-----|-----------|------------|--------|
| Claude Opus 4.5 | 1,200 | 12,000,000 | 1,200,000 | global, us-east5, europe-west4 |
| Claude Sonnet 4.5 | 3,000 | 3,000,000 | 300,000 | global, us-east5, europe-west4 |
| Claude Haiku 4.5 | 10,000 | 10,000,000 | 1,000,000 | global, us-east5, europe-west4 |

<Info>
**Global Endpoint (GA)**: Claude models now support the `global` endpoint on Vertex AI, which dynamically routes requests to regions with available capacity for maximum availability. Use `global` for highest availability unless you have data residency requirements.

See: [Global endpoint for Claude models on Vertex AI](https://cloud.google.com/blog/products/ai-machine-learning/global-endpoint-for-claude-models-generally-available-on-vertex-ai)
</Info>
