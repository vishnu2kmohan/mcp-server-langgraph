...
<CardGroup cols={2}>
  ...
  <Card title="Multi-Environment" icon="layer-group" href="/deployment/infrastructure/multi-environment">
    Dev, stg, and production configurations
  </Card>
...
<Steps>
  ...
  <Step title="Environment Parity">
    **Consistent configs** across dev/stg/prod
