...
icon: 'rocket'
seoTitle: "LangGraph Platform Deployment: Cloud-Native MCP Server"
seoDescription: "Deploy MCP Server on LangGraph Platform. Managed infrastructure, auto-scaling, secrets management, and integrated observability."
keywords: ["LangGraph Platform", "managed deployment", "serverless", "LangGraph Cloud", "managed AI"]
contentType: "how-to"
---
...
```
## STG
langgraph deploy my-agent-stg --tag stg
...
```
## STG uses different LangSmith project
LANGSMITH_PROJECT=my-agent-stg langgraph deploy my-agent-stg
...
<AccordionGroup>
  ...
  <Accordion title="Use STG Environment">
    Deploy to stg before production:

    ```bash
    # Deploy to stg
    langgraph deploy my-agent-stg

    # Test stg thoroughly
    langgraph deployment invoke my-agent-stg --input '...'
