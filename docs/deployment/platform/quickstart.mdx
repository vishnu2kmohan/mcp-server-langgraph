...
icon: 'rocket'
seoTitle: "LangGraph Platform Quickstart - LangGraph Platform"
seoDescription: "LangGraph Platform guide: Get your agent deployed to LangGraph Platform in 2 minutes"
