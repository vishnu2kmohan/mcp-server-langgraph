...
icon: 'gear'
seoTitle: "Platform Configuration - LangGraph Platform"
seoDescription: "LangGraph Platform guide: Configure your LangGraph Platform deployment"
...
<Tabs>
  ...
  <Tab title="STG">
    ...
    # Use stg-specific LangSmith project
