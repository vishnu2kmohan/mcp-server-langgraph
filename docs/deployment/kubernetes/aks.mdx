...
az aks create \
  ...
  --max-count 10 \
  --network-plugin azure \
  --vnet-subnet-id /subscriptions/xxx/resourceGroups/langgraph-rg/providers/Microsoft.Network/virtualNetworks/langgraph-vnet/subnets/aks-subnet \
  ...
  --attach-acr /subscriptions/xxx/resourceGroups/langgraph-rg/providers/Microsoft.ContainerRegistry/registries/langgraphacr
```
...
az identity federated-credential create \
  --name langgraph-agent-federated-credential \
...
az redis create \
  ...
  --zones 1 2 \
  --subnet-id /subscriptions/xxx/resourceGroups/langgraph-rg/providers/Microsoft.Network/virtualNetworks/langgraph-vnet/subnets/redis-subnet
...
spec:
  ...
  secretObjects:
  - secretName: langgraph-agent-secrets
    type: Opaque
    data:
    - objectName: anthropic-api-key
...
docker tag langgraph-agent:latest langgraphacr.azurecr.io/langgraph/agent:latest
