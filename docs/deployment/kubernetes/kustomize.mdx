...
icon: 'layer-group'
seoTitle: "Kustomize Configuration - Kubernetes Deployment"
seoDescription: "Deploy MCP Server on Kubernetes: Manage Kubernetes configurations across environments with Kustomize"
keywords: ["Kubernetes", "Kubernetes", "deployment", "MCP Server", "cloud deployment"]
contentType: "how-to"
---
...
images:
  - name: mcp-server-langgraph
    ...
    newTag: stg
```
#### overlays/stg/deployment-patch.yaml
...
diff <(kubectl kustomize overlays/stg) <(kubectl kustomize overlays/prod)
...
<CardGroup cols={2}>
  ...
  <Card title="CI/CD Pipeline" icon="code-branch" href="/reference/development/ci-cd">
    Continuous delivery
  </Card>
