...
description: Resolution of critical pod crashes in staging environment affecting Keycloak
  and MCP Server deployments
icon: 'dharmachakra'
contentType: explanation
seoTitle: Pod Crash Resolution - 2025-11-12 - MCP Server LangGraph
seoDescription: Resolution of critical pod crashes in staging environment affecting
...
**File**: `deployments/overlays/preview-gke/configmap-patch.yaml`
...
#### Secret Keys Added
**File**: `deployments/overlays/preview-gke/external-secrets.yaml`
...
Validating ConfigMap keys for deployments/overlays/preview-gke...
✓ All ConfigMap keys exist for deployments/overlays/preview-gke
...
### Configuration Files
1. `deployments/overlays/preview-gke/configmap-patch.yaml` (+23 lines)
2. `deployments/overlays/preview-gke/external-secrets.yaml` (+40 lines)
3. `deployments/overlays/preview-gke/keycloak-patch.yaml` (modified security context)
4. `deployments/overlays/preview-gke/kustomization.yaml` (+18 lines - ServiceAccount delete patches)
