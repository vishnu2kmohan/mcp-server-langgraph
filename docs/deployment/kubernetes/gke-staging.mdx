...
flowchart TB
    ...
    classDef githubStyle fill:#24292e,stroke:#f0f6fc,stroke-width:2px,color:#fff
    classDef gcpStyle fill:#4285f4,stroke:#1967d2,stroke-width:2px,color:#fff
    classDef vpcStyle fill:#aecbfa,stroke:#4285f4,stroke-width:2px,color:#000
    classDef gkeStyle fill:#669df6,stroke:#1a73e8,stroke-width:2px,color:#fff
    classDef podStyle fill:#34a853,stroke:#188038,stroke-width:2px,color:#fff
    classDef dbStyle fill:#fbbc04,stroke:#f29900,stroke-width:2px,color:#000
    classDef secretStyle fill:#ea4335,stroke:#c5221f,stroke-width:2px,color:#fff

    class GHA githubStyle
    class GCP gcpStyle
    class VPC vpcStyle
    class GKE,GKE_Features gkeStyle
    class Pods,NetPol,ExtSec podStyle
    class CloudSQL,Redis dbStyle
