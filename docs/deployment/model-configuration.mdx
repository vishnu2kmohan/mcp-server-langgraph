...
icon: 'rocket'
seoTitle: "Model Configuration Strategy - Deployment Guide"
seoDescription: "Deploy MCP Server: This document explains the LLM model configuration strategy across different deployment environments."
...
```bash
FALLBACK_MODELS='["claude-3-5-sonnet-20241022","gpt-5","gemini-2.5-pro"]'
```
...
| gpt-5 | ~3.5s | Balanced performance |
...
2. **Smart Routing**:
   ...
   - Code generation → Claude Sonnet or GPT-5
