  ...
  <Step title="Add GKE Clusters">
    <Tabs>
      <Tab title="Using argocd CLI">
        ...
        argocd cluster add gke_YOUR_PROJECT_ID_us-central1_mcp-prod-gke --name gcp-production
        ```
      </Tab>
      ...
      <Tab title="Using Secrets (Declarative)">
        ...
        kubectl config view --minify --flatten \
          --context=gke_YOUR_PROJECT_ID_us-central1_mcp-prod-gke > prod-cluster.yaml
