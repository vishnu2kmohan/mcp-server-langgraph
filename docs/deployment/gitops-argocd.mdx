...
flowchart TB
    subgraph "Git Repository"
        ...
        C[deployments/overlays/preview-gke/]
  ...
  <Step title="Add GKE Clusters">
    <Tabs>
      <Tab title="Using argocd CLI">
        ...
        argocd cluster add gke_YOUR_PROJECT_ID_us-central1_mcp-preview-gke --name gcp-staging
...
2. mcp-server-gcp-staging
   - Cluster: gcp-staging
   - Path: deployments/overlays/preview-gke
