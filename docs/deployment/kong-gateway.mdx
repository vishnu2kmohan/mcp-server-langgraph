...
graph LR
    ...
    classDef kongStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef pluginStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef lbStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
