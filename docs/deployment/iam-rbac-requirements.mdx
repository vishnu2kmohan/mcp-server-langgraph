...
seoTitle: IAM and RBAC Requirements - MCP Server LangGraph
seoDescription: Multi-cloud IAM/RBAC permissions for CI/CD deployments Learn more
  about MCP Server LangGraph.
keywords:
- iam
- rbac
- requirements
...
### Service Account: `mcp-stg-sa@PROJECT_ID.iam.gserviceaccount.com`
...
SERVICE_ACCOUNT="mcp-stg-sa@${PROJECT_ID}.iam.gserviceaccount.com"
...
metadata:
  ...
  annotations:
    iam.gke.io/gcp-service-account: mcp-stg-sa@PROJECT_ID.iam.gserviceaccount.com
```
#### Verification
...
### Scripts
- **GCP Setup**: `scripts/gcp/setup-stg-infrastructure.sh`
