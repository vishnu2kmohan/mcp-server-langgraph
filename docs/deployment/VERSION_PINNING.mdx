...
description: "Version Pinning Strategy"
icon: "rocket"
---
...
See [VERSION_COMPATIBILITY](/deployment/VERSION_COMPATIBILITY) for detailed infrastructure version matrix.
...
- [VERSION_COMPATIBILITY](/deployment/VERSION_COMPATIBILITY) - Infrastructure version matrix
