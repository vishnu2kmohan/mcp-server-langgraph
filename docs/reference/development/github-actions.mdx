...
icon: 'code'
seoTitle: "GitHub Actions Setup Guide - Developer Reference"
seoDescription: "Development guide: Complete guide for setting up and configuring GitHub Actions for the MCP Server with LangGraph. - [Overview](#overview)"
...
5. **Deploy STG** - Auto-deploy to stg (on `main`)
6. **Deploy Prod** - Manual deploy to prod (on release)
