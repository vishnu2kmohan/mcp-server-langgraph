...
flowchart TB
    ...
    style parallel fill:#2d3748,stroke:#4a5568
```
...
flowchart BT
    ...
    style A fill:#48bb78,stroke:#2f855a,stroke-width:3px
    style B fill:#4299e1,stroke:#2b6cb0,stroke-width:2px
    style C fill:#ed8936,stroke:#c05621,stroke-width:1px
```
