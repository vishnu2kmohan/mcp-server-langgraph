...
icon: 'code'
seoTitle: "IDE Setup Guide - Developer Reference"
seoDescription: "Development guide: This document provides setup instructions for various IDEs and AI coding assistants when working on the MCP Server with LangGraph proje"
