...
icon: 'book'
seoTitle: "Sources & References"
seoDescription: "External sources, academic papers, and references cited throughout the documentation"
keywords: ["MCP Server", "LangGraph", "documentation"]
