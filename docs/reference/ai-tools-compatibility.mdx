---
title: AI Tools Compatibility Guide
description: Comprehensive compatibility matrix for AI coding assistants and IDEs with MCP Server LangGraph, including Claude Code, GitHub Copilot, and Cursor
icon: 'wrench'
contentType: reference
seoTitle: AI Tools Compatibility Matrix - MCP Server LangGraph
seoDescription: Complete AI tools compatibility guide for MCP Server LangGraph. Learn about Claude Code, GitHub Copilot, Cursor, OpenAI Codex, and Gemini Code Assist support.
keywords:
  - ai tools
  - claude code
  - github copilot
