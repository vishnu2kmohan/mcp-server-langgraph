...
icon: 'google'
seoTitle: "Google Gemini Integration: Setup & Configuration"
seoDescription: "Integrate Google Gemini with MCP Server. API key setup, Vertex AI configuration, model selection, and best practices for Gemini 2.0."
keywords: ["Google Gemini", "Gemini 2.0", "Vertex AI", "Google AI Studio", "Gemini API"]
contentType: "how-to"
---
...
<Note>
**New:** Anthropic Claude models are also available via Vertex AI! See the [Vertex AI Setup Guide](./vertex-ai-setup.mdx) for unified access to both Claude and Gemini models.
</Note>
...
| gemini-2.5-flash | 1M tokens | Fast responses, chat | $0.15 input / $0.60 output | ✅ Production |
...
<Tabs>
  ...
  <Tab title="Vertex AI">
    **Best for**: Production, enterprise, private data
    ...
    <Note>
    **Complete Guide**: See the [Vertex AI Setup Guide](./vertex-ai-setup.mdx) for comprehensive instructions including Workload Identity (GKE), multi-provider access (Claude + Gemini), and enterprise deployment.
    </Note>
