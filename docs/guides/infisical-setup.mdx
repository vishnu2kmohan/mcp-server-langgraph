...
icon: 'vault'
seoTitle: "Infisical Secrets Management - Setup Guide"
seoDescription: "Step-by-step guide: Centralized secrets management with Infisical"
...
<Steps>
  ...
  <Step title="Configure Application">
    ...
    INFISICAL_ENVIRONMENT=production  # dev, stg, production
    ```
...
secrets = client.get_all_secrets(
    ...
    environment=environment  # dev, stg, production
)
```
