...
icon: 'message-bot'
seoTitle: "Anthropic Claude Integration: Setup Guide"
seoDescription: "Integrate Anthropic Claude with MCP Server. Claude 3.5 Sonnet, Opus, Haiku configuration. API key setup and best practices."
keywords: ["Anthropic Claude", "Claude 3.5", "Claude Sonnet", "Claude API", "Anthropic integration"]
contentType: "how-to"
---
...
|-------|---------------|----------|-------------------------|
| claude-sonnet-4-5 | 200K tokens | Best performance, coding | $3.00 input / $15.00 output |
| claude-haiku-4-5 | 200K tokens | Fast responses, cost-effective | $1.00 input / $5.00 output |
| claude-opus-4-1 | 200K tokens | Complex analysis, extended reasoning | $15.00 input / $75.00 output |
