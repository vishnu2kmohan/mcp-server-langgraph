...
description: 'Last Updated: 2025-10-20 Applies to: v2.7.0+ This guide helps you migrate from pip-based dependency management to uv. The migration is backward compatible.'
icon: 'book-open'
seoTitle: "Migration Guide: pip → uv - Setup Guide"
seoDescription: "Step-by-step guide: Last Updated: 2025-10-20 Applies to: v2.7.0+ This guide helps you migrate from pip-based dependency management to uv. The migration is "
