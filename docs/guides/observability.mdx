...
@trace(name="custom_step", project="langgraph-agent")
...
<Tabs>
  ...
  <Tab title="ELK Stack">
    ...
    filebeat.inputs:
      - type: container
        paths:
          - '/var/log/containers/*langgraph-agent*.log'
...
<CardGroup cols={2}>
  ...
  <Card title="Alerting" icon="bell" href="/deployment/platform/monitoring#alerting">
    Configure alerts
  </Card>
