...
icon: 'book-open'
seoTitle: "SCIM 2.0 Provisioning Guide - Setup Guide"
seoDescription: "Step-by-step guide: Automate user provisioning and deprovisioning from external identity management systems using SCIM 2.0."
...
flowchart TB
    ...
    subgraph Processing["MCP Server Processing"]
        Validate[Validate Schema]
        Transform[Transform Attributes]
        Keycloak[Create/Update Keycloak]
        OpenFGA[Sync OpenFGA Roles]
    end
    ...
    classDef scimStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef procStyle fill:#bebada,stroke:#7e5eb0,stroke-width:2px,color:#333
    classDef storeStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef respStyle fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    classDef errStyle fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333

    class AzureAD,Okta,Google idpStyle
    class Create,Update,Delete,Search scimStyle
    class Validate,Transform,Keycloak,OpenFGA procStyle
    class KC,FGA,Audit storeStyle
    class Success respStyle
...
- API Reference: [SCIM 2.0 API](/api-reference/scim-provisioning)
- RFC 7643: [SCIM Core Schema](https://datatracker.ietf.org/doc/html/rfc7643)
- RFC 7644: [SCIM Protocol](https://datatracker.ietf.org/doc/html/rfc7644)

#### Related Guides
- **[Service Principals](/guides/service-principals)** - Provision service principals via SCIM
- **[API Key Management](/guides/api-key-management)** - Create API keys for provisioned users
- **[OpenFGA Setup](/guides/openfga-setup)** - Automatic permission sync with SCIM
- **[Permission Model](/guides/permission-model)** - Understanding role-based access control
