...
icon: 'book-open'
seoTitle: "Service Principals Guide - Setup Guide"
seoDescription: "Step-by-step guide: Service principals enable machine-to-machine authentication for batch jobs, streaming tasks, and background processes. They support lon"
...
- API Reference: [Service Principals API](/api-reference/service-principals)
...
#### Related Guides
- **[API Key Management](/guides/api-key-management)** - Alternative authentication for simpler use cases
- **[Identity Federation](/guides/identity-federation-quickstart)** - Federated service principal authentication
- **[SCIM Provisioning](/guides/scim-provisioning)** - Automated service principal provisioning
- **[OpenFGA Setup](/guides/openfga-setup)** - Fine-grained authorization and permission inheritance
