...
icon: 'shield-halved'
seoTitle: "OpenFGA Setup - Setup Guide"
seoDescription: "Step-by-step guide: Deploy and configure OpenFGA for fine-grained authorization"
...
flowchart TB
    ...
    classDef serverStyle fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
    classDef dataStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef modelStyle fill:#fccde5,stroke:#ec7ab8,stroke-width:2px,color:#333
