...
graph TB
    ...
    classDef sdkStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef serverStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef dataStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef modelStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff

    class App appStyle
    class Client sdkStyle
    class API serverStyle
    class Store,PG dataStyle
    class Model,Relations,Tuples modelStyle
```
    ...
    <Tabs>
      ...
      <Tab title="Kubernetes">
        ...
        kubectl wait --for=condition=available --timeout=300s \
          deployment/openfga -n mcp-server-langgraph
        ```
      </Tab>
