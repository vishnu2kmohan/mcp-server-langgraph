...
graph TD
    ...
    Fallback1 -->|✗ Error| Fallback2[Fallback 2<br/>GPT-4o]
    ...
    style Fallback2 fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    style Fallback3 fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
    style Response fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    style Error fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
```
