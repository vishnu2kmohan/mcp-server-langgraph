...
graph TD
    ...
    style Fallback2 fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style Fallback3 fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    style Response fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    style Error fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
```
