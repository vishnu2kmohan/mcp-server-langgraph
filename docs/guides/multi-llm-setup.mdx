...
graph TD
    ...
    style Fallback1 fill:#fff3e0,stroke:#f57c00,stroke-width:2px
    style Fallback2 fill:#fff3e0,stroke:#f57c00,stroke-width:2px
    style Fallback3 fill:#ffebee,stroke:#c62828,stroke-width:2px
