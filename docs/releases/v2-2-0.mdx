---
title: v2.2.0 - Enterprise Compliance
description: 'Enterprise compliance (GDPR/SOC2/HIPAA), SLA monitoring, and observability dashboards'
icon: 'tag'
seoTitle: "v2.2.0 - Enterprise Compliance - Release Notes"
seoDescription: "MCP Server release notes: Enterprise compliance (GDPR/SOC2/HIPAA), SLA monitoring, and observability dashboards"
