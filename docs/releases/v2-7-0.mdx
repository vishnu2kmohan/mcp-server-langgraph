---
title: v2.7.0 - Agentic AI Ready
description: 'Anthropic Agentic Loop Implementation - Full gather-action-verify-repeat cycle with advanced best practices'
icon: 'tag'
seoTitle: "v2.7.0 - Agentic AI Ready - Release Notes"
seoDescription: "MCP Server release notes: Anthropic Agentic Loop Implementation - Full gather-action-verify-repeat cycle with advanced best practices"
...
**See**: [ADR-0024: Agentic Loop Implementation](../architecture/adr-0024-agentic-loop-implementation.mdx)
...
**See**: [ADR-0023: Anthropic Tool Design Best Practices](../architecture/adr-0023-anthropic-tool-design-best-practices.mdx)
...
**See**: [ADR-0025: Anthropic Best Practices - Advanced Enhancements](../architecture/adr-0025-anthropic-best-practices-enhancements.mdx)
...
<AccordionGroup>
  ...
  <Accordion title="Migration Required" icon="code">
    ...
    **See**: [Migration Guide](../guides/authentication-migration-v2-8.mdx)
  </Accordion>
...
**See**: [ADR-0026: Lazy Observability Initialization](../architecture/adr-0026-lazy-observability-initialization.mdx)
