---
title: v2.8.0 - Test Coverage Boost
description: 'Test Coverage & Infrastructure Enhancement - Comprehensive testing improvements with +35% coverage increase'
icon: 'tag'
seoTitle: "v2.8.0 - Test Coverage Boost - Release Notes"
seoDescription: "MCP Server release notes: Test Coverage & Infrastructure Enhancement - Comprehensive testing improvements with +35% coverage increase"
...
<AccordionGroup>
  <Accordion title="search_tools.py (53% → 85%, +32%)" icon="magnifying-glass">
    **File**: `tests/unit/tools/test_search_tools.py` (+226 lines)
...
flowchart TB
    ...
    classDef suiteStyle fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    classDef unitStyle fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
    classDef integrationStyle fill:#fccde5,stroke:#ec7ab8,stroke-width:2px,color:#333
    classDef dockerStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef serviceStyle fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333

    class A suiteStyle
    class B,E,F unitStyle
    class C,G,H integrationStyle
    class D dockerStyle
    class I,J,K serviceStyle
```
#### Coverage Thresholds
