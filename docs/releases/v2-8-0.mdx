...
graph TB
    ...
    classDef suiteStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef unitStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef integrationStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
    classDef dockerStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef serviceStyle fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
