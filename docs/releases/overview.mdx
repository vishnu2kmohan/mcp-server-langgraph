...
graph LR
    ...
    style V1 fill:#1b9e77,color:#fff
    style V2 fill:#1b9e77,color:#fff
    style V21 fill:#66a61e,color:#fff
    style V22 fill:#66a61e,color:#fff
    style V23 fill:#d95f02,color:#fff
    style V24 fill:#d95f02,color:#fff
    style V25 fill:#7570b3,color:#fff
    style V26 fill:#e7298a,color:#fff
    style V27 fill:#e6ab02,color:#fff
