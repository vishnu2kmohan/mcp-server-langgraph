...
graph LR
    ...
    %% ColorBrewer2 Dark2 palette - progressive version timeline
    style V1 fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    style V2 fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    style V21 fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    style V22 fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    style V23 fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style V24 fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style V25 fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    style V26 fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
    style V27 fill:#e6ab02,stroke:#b38501,stroke-width:2px,color:#fff
    style V28 fill:#a6761d,stroke:#735214,stroke-width:3px,color:#fff
```
