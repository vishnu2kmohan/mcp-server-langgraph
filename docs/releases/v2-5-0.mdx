---
title: v2.5.0 - Integration Testing
description: 'Structured JSON logging, multi-platform log aggregation, containerized tests, and Infisical installation'
icon: 'tag'
seoTitle: "v2.5.0 - Integration Testing - Release Notes"
seoDescription: "MCP Server release notes: Structured JSON logging, multi-platform log aggregation, containerized tests, and Infisical installation"
