...
|---------|---------------------------|---------------------------|
| **Getting Started** | ✅ Under 20 lines of code | 🔄 Coming soon: `mcpserver init` |
...
| **Authorization** | ✅ Azure RBAC | ✅ OpenFGA (Zanzibar model) |
