...
| **Development** | ✅ Visual Agent Builder | ⚠️ Code (coming: visual builder) |
...
<AccordionGroup>
  ...
  <Accordion title="MCP Server Visual Builder (Planned)">
    ...
    **Approach:**
    - Visual builder **generates code**
    - Code is editable and versionable
    - Best of both worlds: visual + code

    **Current State:**
    - Code-first development fully supported
    - Visual builder in development

    **Strengths:**
    - Full code control (export feature)
    - Works with any LLM provider
    - Can self-host
    - Production-grade output

    **Limitations:**
    - Not available yet (Q2 2025)
    - Currently code-only
  </Accordion>
</AccordionGroup>

**Current Winner:** OpenAI AgentKit (visual builder exists now)
**Future Winner:** MCP Server with LangGraph (visual + code export capability)
...
| **Authorization** | ⚠️ Basic (per-agent) | ✅ OpenFGA (Zanzibar model) |
...
<Note>
  **Migration Tool Planned:** `mcpserver migrate --from openai-agentkit` to automate conversion.
</Note>
...
| Feature | OpenAI AgentKit | MCP Server with LangGraph |
|---------|----------------|---------------------------|
| **Agent Builder** | ⚠️ Beta | 🔄 Planned Q2 2025 |
| **ChatKit** | ✅ GA | ⚠️ Playground (planned) |
