...
<CardGroup cols={2}>
  ...
  <Card title="Integration Guide" icon="file" href="/LANGSMITH_INTEGRATION.md">
    Detailed integration guide
  </Card>
  <Card title="API Reference" icon="code" href="https://docs.smith.langchain.com/api-reference">
    LangSmith API reference
  </Card>
  <Card title="Example Code" icon="github" href="https://github.com/vishnu2kmohan/mcp_server_langgraph/blob/main/examples/langsmith_tracing.py">
