...
icon: 'chart-line'
seoTitle: "Observability - Getting Started"
seoDescription: "Get started with MCP Server: OpenTelemetry tracing, metrics, and LangSmith integration"
...
flowchart TB
    ...
    subgraph Application["Application Layer"]
        App[Application Code<br/>FastAPI + LangGraph]
        Auto[Auto-Instrumentation<br/>HTTP, AsyncIO, LLM]
    end
    ...
    subgraph Export["OTLP Export"]
        OTLP[OTLP Exporter<br/>gRPC:4317]
    end

    subgraph Processing["Collector Processing"]
        Collector[OpenTelemetry Collector]
        Batch[Batching<br/>Memory-efficient]
        Sample[Sampling<br/>10% default]
        Filter[Filtering<br/>Attribute-based]
    end
    ...
    classDef otelStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef collectorStyle fill:#bebada,stroke:#7e5eb0,stroke-width:2px,color:#333
    classDef backendStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef vizStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333

    class App,Auto appStyle
    class Traces,Metrics,Logs,OTLP otelStyle
    class Collector,Batch,Sample,Filter collectorStyle
    class Jaeger,Prometheus,Loki backendStyle
    class JaegerUI,Grafana,PromUI vizStyle
```
