...
icon: 'paper-plane'
seoTitle: "Your First Request: Send Messages to MCP Server"
seoDescription: "Learn how to send your first request to MCP Server with LangGraph. Examples in Python, cURL, and JavaScript for HTTP and stdio transports."
keywords: ["MCP first request", "LangGraph API", "AI agent messaging", "HTTP transport", "stdio transport"]
