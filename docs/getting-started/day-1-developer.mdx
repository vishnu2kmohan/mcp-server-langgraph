...
description: Get from zero to running your first LangGraph MCP agent in under 5 minutes
  with progressive onboarding paths
icon: 'rocket'
contentType: tutorial
seoTitle: Day-1 Developer Guide - MCP Server LangGraph
seoDescription: Get from zero to running your first LangGraph MCP agent in under 5
  minutes with progressive onboarding paths Learn more about MCP Server LangGraph.
keywords:
- day-1
- developer
- guide
...
- [Authentication Setup](/getting-started/authentication)
- [Observability Configuration](/getting-started/observability)
...
- **Issue with quickstart?** Check [Troubleshooting](/advanced/troubleshooting)
- **Understanding architecture?** See [Architecture Overview](/architecture/overview)
- **Contributing?** Read [Contributing Guide](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/CONTRIBUTING.md)
