...
graph TB
    ...
    %% ColorBrewer2 Set3 palette styling - unique colors per node type
    ...
    classDef telemetryStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333
    classDef backendStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef dashboardStyle fill:#fccde5,stroke:#ec7ab8,stroke-width:2px,color:#333
    ...
    class LLM llmStyle
    class Otel telemetryStyle
    class Jaeger,Prom backendStyle
    class Grafana dashboardStyle
