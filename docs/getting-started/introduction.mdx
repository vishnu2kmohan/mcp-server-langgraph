...
graph TB
    ...
    Server --> Auth[JWT Auth]
    Auth --> AuthZ[OpenFGA AuthZ]
    AuthZ --> Agent[LangGraph Agent]
    ...
    class Agent,Tools agentStyle
    class LLM llmStyle
    class Otel,Jaeger,Prom,Grafana,Secrets obsStyle
```
