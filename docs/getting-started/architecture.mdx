...
graph TB
    ...
    %% ColorBrewer2 Dark2 palette styling
    classDef clientStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef gatewayStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
    classDef appStyle fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    classDef llmStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
    classDef authStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef authzStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef dataStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef obsStyle fill:#e6ab02,stroke:#b38501,stroke-width:2px,color:#fff
    classDef secretsStyle fill:#a6761d,stroke:#735214,stroke-width:2px,color:#fff

    class WebApp,CLI,API clientStyle
    class Ingress,Kong gatewayStyle
    class MCP,Agent,Auth appStyle
    class LiteLLM,Anthropic,Google,OpenAI,Ollama llmStyle
    class Keycloak,JWT,Sessions authStyle
    class OpenFGA,RoleMapper authzStyle
...
graph LR
    ...
    style User fill:#1b9e77,color:#fff
    style User2 fill:#1b9e77,color:#fff
    style Org fill:#d95f02,color:#fff
    style Tool1 fill:#7570b3,color:#fff
    style Tool2 fill:#7570b3,color:#fff
```
...
<Tabs>
  <Tab title="Architecture">
    ...
    graph LR
        ...
        %% ColorBrewer2 Dark2 palette styling
        classDef appStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
        classDef managerStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
        classDef storeStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
        classDef redisStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
...
graph TB
    ...
    %% ColorBrewer2 Dark2 palette styling
    classDef agentStyle fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    classDef routerStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef primaryStyle fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef fallbackStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef llmStyle fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
  ...
  <Tab title="OpenTelemetry">
    **Distributed tracing and metrics**
    ...
    graph LR
        ...
        %% ColorBrewer2 Dark2 palette styling
        classDef appStyle fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
        classDef exporterStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
        classDef collectorStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
        classDef backendStyle fill:#e6ab02,stroke:#b38501,stroke-width:2px,color:#fff
