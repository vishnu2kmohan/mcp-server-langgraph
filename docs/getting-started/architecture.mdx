...
graph TB
    ...
    classDef gatewayStyle fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
...
graph LR
    ...
    style User fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    style User2 fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    style Org fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    style Tool1 fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
    style Tool2 fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
```
