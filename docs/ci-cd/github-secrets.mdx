...
| Variable | Required | Default | Description |
|----------|----------|---------|-------------|
| `GKE_STG_CLUSTER` | No | `stg-mcp-server-langgraph-gke` | STG GKE cluster name |
...
| Variable | Required | Default | Description |
|----------|----------|---------|-------------|
| `STG_NAMESPACE` | No | `stg-mcp-server-langgraph` | Kubernetes namespace for stg |
...
| `GCP_STG_SA_EMAIL` | ✅ Yes | `SERVICE_ACCOUNT@PROJECT_ID.iam.gserviceaccount.com` | STG service account email |
...
GCP_STG_SA_EMAIL=mcp-stg-sa@vishnu-sandbox-20250310.iam.gserviceaccount.com
...
gcloud iam service-accounts create mcp-stg-sa \
...
gcloud projects add-iam-policy-binding YOUR_PROJECT_ID \
    --member="serviceAccount:mcp-stg-sa@YOUR_PROJECT_ID.iam.gserviceaccount.com" \
...
gcloud iam service-accounts add-iam-policy-binding mcp-stg-sa@YOUR_PROJECT_ID.iam.gserviceaccount.com \
...
- `GCP_STG_SA_EMAIL` or `GCP_PROD_SA_EMAIL` (secret)
...
- **Use environment-specific** service accounts (separate stg/production)
