...
description: DORA metrics, performance regression detection, and observability integration
  for elite-level CI/CD
icon: 'trophy'
contentType: how-to
seoTitle: Elite CI/CD Features - MCP Server LangGraph
seoDescription: DORA metrics, performance regression detection, and observability
  integration for elite-level CI/CD Learn more about MCP Server LangGraph.
keywords:
- elite
- features
- dora
...
**File**: `.github/workflows/deploy-prod-gke.yaml`
