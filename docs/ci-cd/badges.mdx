...
[![Deploy STG](https://github.com/vishnu2kmohan/mcp-server-langgraph/actions/workflows/deploy-stg-gke.yaml/badge.svg)](https://github.com/vishnu2kmohan/mcp-server-langgraph/actions/workflows/deploy-stg-gke.yaml)
[![Deploy Production](https://github.com/vishnu2kmohan/mcp-server-langgraph/actions/workflows/deploy-prod-gke.yaml/badge.svg)](https://github.com/vishnu2kmohan/mcp-server-langgraph/actions/workflows/deploy-prod-gke.yaml)
...
| `GCP_STG_SA_EMAIL` | Secret | STG service account email |
| `GCP_PROD_SA_EMAIL` | Secret | Production service account email |
