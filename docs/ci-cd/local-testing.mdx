...
**Historical Issue**: E2E tests failing with `ModuleNotFoundError: No module named 'black'`

**What Happened**:
```bash
# CI workflow used:
uv sync  # Missing --extra dev
...
act workflow_dispatch -W .github/workflows/deploy-preview-gke.yaml
```
---
...
- name: Install dependencies
  run: |
    uv sync --extra dev  # ← Added --extra flags
```
...
# Test with secrets
act push -W .github/workflows/deploy-preview-gke.yaml --secret-file .secrets
```
---
...
| ModuleNotFoundError: No module named 'black'  ← Missing: --extra dev
```
