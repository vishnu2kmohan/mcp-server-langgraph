...
<Warning>
**Deprecation Notice (2025-12-13)**: The Builder API has been consolidated into the [Unified API v1](/guides/api-migration-guide).

- **New endpoint**: `/api/v1/workflows/*` (replaces `/api/builder/*`)
...
<Info>
**Unified Studio Frontend**: The Builder UI has been consolidated into the Unified Studio at `/studio/*`. Key routes:
- `/studio/workflows` - Visual workflow builder with React Flow canvas
- `/studio/mcp` - MCP tools, resources, and prompts explorer
- `/studio/settings` - User settings and preferences

See the [Visual Workflow Builder Guide](/guides/visual-workflow-builder) for frontend usage.
</Info>
