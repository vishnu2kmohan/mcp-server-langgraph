...
```
302 Found
Location: https://sso.yourdomain.com/realms/langgraph-agent/protocol/openid-connect/auth?client_id=...
```
...
```
302 Found
Location: https://sso.yourdomain.com/realms/langgraph-agent/protocol/openid-connect/logout
```
...
<CardGroup cols={2}>
  ...
  <Card title="Authorization API" icon="shield-halved" href="/api-reference/authorization">
