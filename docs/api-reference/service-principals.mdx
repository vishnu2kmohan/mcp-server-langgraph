...
description: API endpoints for managing service principals and machine-to-machine
  authentication
icon: 'robot'
contentType: reference
seoTitle: Service Principals API - MCP Server LangGraph
seoDescription: API endpoints for managing service principals and machine-to-machine
  authentication Learn more about MCP Server LangGraph.
keywords:
- service
- principals
- api
