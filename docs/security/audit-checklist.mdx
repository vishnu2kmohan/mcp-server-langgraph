...
seoTitle: "Security Audit Checklist - Security Guide"
seoDescription: "Security best practices: Comprehensive security audit checklist for production deployments"
...
<Warning>
**Do not deploy to prod until all critical items are addressed.** High and critical items must be resolved; medium items should be planned for resolution.
</Warning>
...
kubectl kustomize overlays/prod | kubesec scan -
