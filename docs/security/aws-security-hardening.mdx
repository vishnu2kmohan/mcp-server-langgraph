...
flowchart LR
    ...
    classDef excellent fill:#8dd3c7,stroke:#555,color:#000
    classDef good fill:#fdb462,stroke:#555,color:#000

    class IRSA,MFA,VPC,KMS,TLS,PSS excellent
    class IAM,SG,SM,RBAC good
    class NP,Scan good
```
---
