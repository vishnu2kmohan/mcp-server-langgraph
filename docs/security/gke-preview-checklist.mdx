---
title: GKE Preview Security Checklist
description: 'Comprehensive security checklist to verify that your GKE preview environment follows security best practices'
icon: 'clipboard-check'
seoTitle: "GKE Preview Security Checklist - Security Guide"
seoDescription: "Security best practices: Comprehensive security checklist to verify that your GKE preview environment follows security best practices"
...
gcloud compute networks subnets describe preview-gke-subnet \
  --region=us-central1 \
  --format=yaml
```
