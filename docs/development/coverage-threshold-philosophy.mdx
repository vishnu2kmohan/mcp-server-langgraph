...
description: "Understanding and applying coverage thresholds across different test types"
icon: "chart-line"
---
...
**Related**: [Testing Guide](/advanced/testing), [CI/CD Pipeline](/deployment/ci-cd)
...
- [CI/CD Pipeline](/deployment/ci-cd) - Workflow architecture
- [Quality Tests Workflow](/.github/workflows/quality-tests.yaml) - Contract, property, regression tests
- [E2E Tests Workflow](/.github/workflows/e2e-tests.yaml) - End-to-end user journeys
- [Integration Tests Workflow](/.github/workflows/integration-tests.yaml) - Component integration testing
