...
**Related**: [CI/CD Pipeline](/deployment/ci-cd), [Coverage Threshold Philosophy](/development/coverage-threshold-philosophy)
...
- [Setup Python Deps Action](/.github/actions/setup-python-deps/action.yml)
