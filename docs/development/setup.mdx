...
description: "Complete guide for setting up the MCP Server LangGraph development environment with all required and optional tools."
icon: "wrench"
contentType: "how-to"
seoTitle: "Developer Setup Guide | MCP Server LangGraph"
seoDescription: "Complete guide for setting up the MCP Server LangGraph development environment with all required and optional tools."
keywords: ["setup", "development", "installation", "environment", "tools"]
---
...
4. **Read development guides:**
   - [Testing Guide](advanced/testing.mdx) - Test-driven development guide
   - [Contributing Guidelines](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/CONTRIBUTING.md) - Contribution guidelines
   - [Project Overview](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/README.md) - Main project README
