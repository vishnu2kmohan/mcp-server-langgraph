...
description: "Portable health check patterns for Docker Compose services that work across minimal base images without relying on utilities like curl or wget"
icon: "heart-pulse"
contentType: "guide"
---
