...
description: Production-ready authentication with Keycloak for MCP Server LangGraph, including OAuth2/OIDC, JWKS token verification, and role synchronization
icon: 'shield'
contentType: how-to
seoTitle: Keycloak Authentication Integration - MCP Server LangGraph
seoDescription: Complete Keycloak integration guide for MCP Server LangGraph. Learn OAuth2/OIDC authentication, token management, OpenFGA role mapping, and production deployment.
keywords:
  - keycloak
  - authentication
  - oauth2
...
| **STG** | Keycloak | Pre-production validation |
...
# Step 2: STG with Keycloak (pre-production testing)
AUTH_PROVIDER=keycloak
KEYCLOAK_SERVER_URL=https://stg-keycloak.example.com
...
4. **Production Deploy**: Follow [Production Deployment Guide](/deployment/production-checklist)
5. **Monitor & Alert**: Set up Grafana dashboards and alerts

## Related Documentation

- [OpenFGA & Infisical Integration](/integrations/openfga-infisical)
- [Production Deployment Guide](/deployment/production-checklist)
- [Testing Guide](/advanced/testing)
- [Feature Flags](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/src/mcp_server_langgraph/core/feature_flags.py)
