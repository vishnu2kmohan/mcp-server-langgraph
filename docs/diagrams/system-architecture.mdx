...
description: 'This file contains Mermaid diagrams for the MCP Server LangGraph system architecture. Client[MCP Client<br/>Claude Desktop, Custom Apps]'
icon: 'diagram-project'
seoTitle: "System Architecture Diagram - System Diagrams"
seoDescription: "Visual architecture: This file contains Mermaid diagrams for the MCP Server LangGraph system architecture. Client[MCP Client<br/>Claude Desktop, Custom Apps"
keywords: ["architecture diagram", "system design", "visual guide", "MCP architecture"]
...
flowchart TD
    ...
    %% Styling (ColorBrewer2 Set3 palette)
    classDef client fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    classDef server fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef auth fill:#bebada,stroke:#8e7cc3,stroke-width:2px,color:#333
    classDef agent fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    classDef llm fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
    classDef services fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef obs fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333
...
flowchart TD
    ...
    classDef contextStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef decisionStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333
    classDef toolStyle fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    classDef llmStyle fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
    classDef verifyStyle fill:#bc80bd,stroke:#8e44ad,stroke-width:2px,color:#333
    classDef routeStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333

    class Start,End startEndStyle
    class LoadContext,CompactCtx,ExtractNotes,SaveState contextStyle
    class Compact,Quality,Refine,Decision decisionStyle
    class ExecuteTools toolStyle
    class GenerateResp,RefineResp llmStyle
...
flowchart TB
    ...
    classDef serviceStyle fill:#fccde5,stroke:#ec7ab8,stroke-width:2px,color:#333

    class Users externalStyle
    class Ingress,Kong ingressStyle
    class AgentPod1,AgentPod2,AgentPod3,HPA appStyle
    class KeycloakPod1,KeycloakPod2,OpenFGAPod1,OpenFGAPod2 authStyle
    class PostgresDB,RedisPod,QdrantPod dataStyle
    class OTELCol,JaegerPod,PrometheusPod,GrafanaPod obsStyle
    class Anthropic,OpenAI,Google,Infisical serviceStyle
```
...
flowchart LR
    ...
    classDef layer1Style fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    classDef layer2Style fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
    classDef layer3Style fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef syncStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333
    classDef toolStyle fill:#ccebc5,stroke:#82c99a,stroke-width:2px,color:#333

    class Request,Results startEndStyle
    class Analyzer,Graph,Topo analysisStyle
    class Layer1 layer1Style
    class Layer2 layer2Style
    class Layer3 layer3Style
    class Sync1,Sync2 syncStyle
    class Tool1A,Tool1B,Tool1C,Tool2A,Tool2B,Tool3 toolStyle
```
...
flowchart TD
    ...
    classDef searchStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef loadStyle fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333
    classDef contextStyle fill:#ccebc5,stroke:#82c99a,stroke-width:2px,color:#333
    classDef noteStyle fill:#d9d9d9,stroke:#95a5a6,stroke-width:2px,color:#333

    class UserQuery,AgentInvoke startEndStyle
    class CheckCache,TokenCheck,TokenFit decisionStyle
    class LoadCache,CacheResults cacheStyle
    class Search,TopK,Embed searchStyle
    class LoadAll,Progressive,LoadContext,StopLoading loadStyle
    class InjectMsg contextStyle
...
flowchart TD
    ...
    classDef middlewareStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef storeStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef backendStyle fill:#bc80bd,stroke:#8e44ad,stroke-width:2px,color:#333
    classDef featureStyle fill:#b3de69,stroke:#7cb342,stroke-width:2px,color:#333

    class User clientStyle
    class CreateSession,GetSession,RefreshSession,RevokeSession middlewareStyle
    class InMemory,Redis storeStyle
    class MemDict,RedisDB backendStyle
    class Sliding,ConcurrentLimit,BulkRevoke,Tracking featureStyle
```
...
flowchart LR
    ...
    classDef failureStyle fill:#fb8072,stroke:#e74c3c,stroke-width:2px,color:#333
    classDef metricsStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef alertStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333

    class Request,End startEndStyle
    class Primary,Fallback1,Fallback2,Fallback3,Alert decisionStyle
    class Response successStyle
    class Log1,Log2,Log3,Error failureStyle
    class Metrics metricsStyle
    class Notify alertStyle
```
...
flowchart TB
    ...
    %% ColorBrewer2 Set3 palette - each component type uniquely colored
    classDef appStyle fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    classDef instrumentStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef collectionStyle fill:#80b1d3,stroke:#3498db,stroke-width:2px,color:#333
    classDef backendStyle fill:#bc80bd,stroke:#8e44ad,stroke-width:2px,color:#333
    classDef vizStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333

    class Agent,Auth,Tools,LLM appStyle
    class TracerProvider,MeterProvider,LoggerProvider instrumentStyle
    class Receiver,Processor,Exporter collectionStyle
    class Jaeger,Prometheus,LangSmith,CloudWatch backendStyle
    class Grafana,JaegerUI,LangSmithUI vizStyle
```
...
To use these diagrams in Mintlify `.mdx` files, copy any of the diagram blocks above and paste them into your documentation. The diagrams will render automatically in Mintlify.
