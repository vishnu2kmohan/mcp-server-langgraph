...
graph TD
    ...
    %% Styling (ColorBrewer2 Dark2 palette - dark mode friendly)
    classDef client fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    classDef server fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef auth fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    classDef agent fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    classDef llm fill:#e7298a,stroke:#b31e6d,stroke-width:2px,color:#fff
    classDef services fill:#e6ab02,stroke:#b38501,stroke-width:2px,color:#fff
    classDef obs fill:#a6761d,stroke:#735214,stroke-width:2px,color:#fff
...
flowchart TD
    ...
    style LoadContext fill:#1b9e77,color:#fff
    style Compact fill:#d95f02,color:#fff
    style Route fill:#7570b3,color:#fff
    style ExecuteTools fill:#66a61e,color:#fff
    style GenerateResp fill:#66a61e,color:#fff
    style Verify fill:#e7298a,color:#fff
    style ExtractNotes fill:#e6ab02,color:#fff
    style Quality fill:#d95f02,color:#fff
    style Refine fill:#a6761d,color:#fff
```
...
graph TB
    ...
    style PostgresDB fill:#1b9e77,stroke:#116b52,stroke-width:3px,color:#fff
    style RedisPod fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style QdrantPod fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
```
...
graph LR
    ...
    style Tool1A fill:#66a61e,stroke:#477315,color:#fff
    style Tool1B fill:#66a61e,stroke:#477315,color:#fff
    style Tool1C fill:#66a61e,stroke:#477315,color:#fff
    style Tool2A fill:#d95f02,stroke:#a64801,color:#fff
    style Tool2B fill:#d95f02,stroke:#a64801,color:#fff
    style Tool3 fill:#e7298a,stroke:#b31e6d,color:#fff
```
...
flowchart TD
    ...
    style CheckCache fill:#1b9e77,color:#fff
    style Search fill:#7570b3,color:#fff
    style Progressive fill:#d95f02,color:#fff
    style CacheResults fill:#66a61e,color:#fff
...
graph TD
    ...
    style InMemory fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    style Redis fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style Sliding fill:#1b9e77,color:#fff
    style ConcurrentLimit fill:#e6ab02,color:#fff
    style BulkRevoke fill:#7570b3,color:#fff
    style Tracking fill:#66a61e,color:#fff
```
...
flowchart LR
    ...
    style Primary fill:#1b9e77,stroke:#116b52,stroke-width:2px,color:#fff
    style Fallback1 fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    style Fallback2 fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
    style Fallback3 fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
    style Error fill:#e7298a,stroke:#b31e6d,stroke-width:3px,color:#fff
    style Response fill:#66a61e,stroke:#477315,stroke-width:2px,color:#fff
```
...
graph TB
    ...
    style Agent fill:#1b9e77,color:#fff
    style Auth fill:#7570b3,color:#fff
    style Tools fill:#66a61e,color:#fff
    style LLM fill:#e7298a,color:#fff
    style Grafana fill:#e6ab02,stroke-width:3px,color:#fff
    style JaegerUI fill:#e6ab02,stroke-width:3px,color:#fff
    style LangSmithUI fill:#e6ab02,stroke-width:3px,color:#fff
```
