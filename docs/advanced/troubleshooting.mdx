...
<AccordionGroup>
  ...
  <Accordion title="Redis connection timeout">
    ...
    **Debug**:
    ...
    kubectl exec -it mcp-server-langgraph-xxx -- redis-cli -h redis-master ping
    ```
...
<AccordionGroup>
  ...
  <Accordion title="High memory usage">
    ...
    **Debug**:
    ...
    kubectl describe pod mcp-server-langgraph-xxx | grep -A 5 Limits
  ...
  <Accordion title="CPU throttling">
    ...
    **Debug**:
    ...
    # Check throttling
    kubectl describe pod mcp-server-langgraph-xxx | grep -i throttl
