...
icon: 'code'
seoTitle: "Development Setup - Advanced Topics"
seoDescription: "Advanced guide: Complete development environment setup guide"
...
<Warning>
**Most developers don't need this section.** `uv sync` handles everything automatically.

Only use manual `uv venv` if you need:
...
<AccordionGroup>
  ...
  <Accordion title="Tests Failing" icon="vial">
    ...
    pytest tests/unit/auth/test_auth.py::test_create_token -vv
