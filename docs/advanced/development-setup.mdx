...
# Install core tools
brew install python@3.12 git docker docker-compose
...
# Verify installation
python -c "import fastapi, langchain, anthropic; print('All imports successful')"
```
...
docker-run:  ## Run Docker container
	docker run -p 8000:8000 --env-file .env langgraph-agent:dev
...
# Cache Docker layers
docker build --cache-from langgraph-agent:latest .
```
