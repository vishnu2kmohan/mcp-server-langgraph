---
title: "8. Infisical for Secrets Management"
description: 'Architecture Decision Record: 8. Infisical for Secrets Management'
icon: 'lock'
contentType: "reference"
seoTitle: "8. Infisical for Secrets Management - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 8. Infisical for Secrets Management. Category: Security & Compliance. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- **Multi-Environment**: Dev, stg, production isolation
...
- Related ADRs: [ADR-0002](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0002-openfga-authorization.md), [ADR-0007](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0007-authentication-provider-pattern.md)
