...
icon: 'file-lines'
seoTitle: "ADR-0008: 8. Infisical for Secrets Management"
seoDescription: "Architecture Decision Record 0008: Architecture Decision Record: 8. Infisical for Secrets Management"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "8."]
...
- Related ADRs: [ADR-0002](/architecture/adr-0002-openfga-authorization), [ADR-0007](/architecture/adr-0007-authentication-provider-pattern)
