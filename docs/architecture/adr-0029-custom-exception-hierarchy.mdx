---
title: "ADR-0029: Custom Exception Hierarchy"
...
- [ADR-0017: Error Handling Strategy](./adr-0017-error-handling-strategy)
- [ADR-0026: Resilience Patterns](./adr-0026-resilience-patterns)
- [API Error Responses](/api-reference/errors)
