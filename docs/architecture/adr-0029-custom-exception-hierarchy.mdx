...
seoTitle: "29. Custom Exception Hierarchy - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 29. Custom Exception Hierarchy. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- [ ] Deploy to stg, test error flows
- [ ] Deploy to prod
