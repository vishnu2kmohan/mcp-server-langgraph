...
- **Related ADRs**:
  - [ADR-0006](adr-0006-session-storage-architecture.mdx) - Pluggable session storage (similar pattern)
  - [ADR-0015](adr-0015-memory-checkpointing.mdx) - Original checkpointing decision (superseded)
  - [ADR-0013](adr-0013-multi-deployment-target-strategy.mdx) - Multi-cloud deployment patterns
