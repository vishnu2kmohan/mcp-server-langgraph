---
title: 'ADR-0022: Distributed Conversation Checkpointing'
description: 'Enable HPA auto-scaling with Redis-backed conversation state'
icon: 'database'
---
...
- **Related ADRs**:
  - [ADR-0006](adr-0006-session-storage-architecture) - Pluggable session storage (similar pattern)
  - [ADR-0015](adr-0015-memory-checkpointing) - Original checkpointing decision (superseded)
  - [ADR-0013](adr-0013-multi-deployment-target-strategy) - Multi-cloud deployment patterns
