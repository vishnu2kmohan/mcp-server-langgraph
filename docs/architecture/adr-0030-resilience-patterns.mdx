...
icon: 'file-lines'
seoTitle: "ADR-0030: 30. Resilience Patterns"
seoDescription: "Architecture Decision Record 0030: Comprehensive resilience layer with circuit breakers, retries, timeouts, and bulkhead isolation"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "30."]
