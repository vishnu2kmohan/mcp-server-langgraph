---
title: "30. Resilience Patterns for Production Systems"
description: 'Architecture Decision Record: 30. Resilience Patterns for Production Systems'
icon: 'life-ring'
contentType: "reference"
seoTitle: "30. Resilience Patterns for Production Systems - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 30. Resilience Patterns for Production Systems. Category: Performance & Resilience. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- See [ADR-0057](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0057-circuit-breaker-decorator-closure-isolation.md) for the full analysis
...
2. **STG**: A/B test (50% traffic with resilience)
