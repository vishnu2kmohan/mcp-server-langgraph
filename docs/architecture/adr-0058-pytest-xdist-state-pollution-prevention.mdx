...
description: Architectural decision record documenting the resolution of pytest-xdist
  state pollution issues causing intermittent auth test failures
icon: sitemap
contentType: explanation
seoTitle: 'ADR-0053: Pytest-xdist State... - MCP Server LangGraph'
seoDescription: Architectural decision record documenting the resolution of pytest-xdist
  state pollution issues causing intermittent auth test failures
keywords:
- adr-0053
- pytest-xdist
