...
- Configuration: `src/mcp_server_langgraph/core/config.py`
- Related ADRs:
  - [ADR-0007](adr-0007-authentication-provider-pattern.mdx) - Pluggable auth providers
  - [ADR-0002](adr-0002-openfga-authorization.mdx) - Authorization (sessions tied to users)
