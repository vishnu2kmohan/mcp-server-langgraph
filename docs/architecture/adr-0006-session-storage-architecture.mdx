...
seoTitle: "6. Pluggable Session Storage Architecture - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 6. Pluggable Session Storage Architecture. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- Configuration: `src/mcp_server_langgraph/core/config.py`
- Related ADRs:
  - [ADR-0007](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0007-authentication-provider-pattern.md) - Pluggable auth providers
  - [ADR-0002](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0002-openfga-authorization.md) - Authorization (sessions tied to users)
