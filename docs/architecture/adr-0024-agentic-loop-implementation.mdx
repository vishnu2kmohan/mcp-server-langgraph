...
- **Related ADRs**:
  - [ADR-0005](adr-0005-pydantic-ai-integration.mdx) - Type-safe responses
  - [ADR-0010](adr-0010-langgraph-functional-api.mdx) - Functional API choice
  - [ADR-0022](adr-0022-distributed-conversation-checkpointing.mdx) - Checkpointing
  - [ADR-0023](adr-0023-anthropic-tool-design-best-practices.mdx) - Tool design
