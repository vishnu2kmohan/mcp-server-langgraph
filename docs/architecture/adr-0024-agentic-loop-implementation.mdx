...
icon: 'file-lines'
seoTitle: "ADR-0024: 24. Agentic Loop Implementation Following Anthropi"
seoDescription: "Architecture Decision Record 0024: Architecture Decision Record: 24. Agentic Loop Implementation Following Anthropic Best Practices"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "24."]
