...
icon: 'file-lines'
seoTitle: "ADR-0007: 7. Pluggable Authentication Provider Pattern"
seoDescription: "Architecture Decision Record 0007: Architecture Decision Record: 7. Pluggable Authentication Provider Pattern"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "7."]
...
- AuthMiddleware: `src/mcp_server_langgraph/auth/middleware.py`
- Related ADRs:
  - [ADR-0006](/architecture/adr-0006-session-storage-architecture) - Session storage (used with auth)
  - [ADR-0002](/architecture/adr-0002-openfga-authorization) - Authorization (role sync target)
