...
seoTitle: "7. Pluggable Authentication Provider Pattern - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 7. Pluggable Authentication Provider Pattern. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
**Use Cases**: Production, stg, enterprise deployments
...
- AuthMiddleware: `src/mcp_server_langgraph/auth/middleware.py`
- Related ADRs:
  - [ADR-0006](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0006-session-storage-architecture.md) - Session storage (used with auth)
  - [ADR-0002](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0002-openfga-authorization.md) - Authorization (role sync target)
