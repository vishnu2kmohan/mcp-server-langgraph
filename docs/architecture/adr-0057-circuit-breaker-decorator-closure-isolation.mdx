---
title: 57. Circuit Breaker Decorator Closure Isolation
description: 'Test isolation fix for circuit breaker decorator closure state in pytest-xdist'
icon: 'file-lines'
seoTitle: "ADR-0057: Circuit Breaker Decorator Closure Isolation"
seoDescription: "Architecture Decision Record 0057: Test isolation fix for circuit breaker decorator closure state in pytest-xdist parallel execution"
keywords: ["ADR", "architecture decision", "circuit-breaker", "testing", "pytest-xdist", "state-isolation"]
