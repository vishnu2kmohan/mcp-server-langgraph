...
icon: 'file-lines'
seoTitle: "ADR-0011: 11. Cookiecutter Template for Project Generation"
seoDescription: "Architecture Decision Record 0011: Architecture Decision Record: 11. Cookiecutter Template for Project Generation"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "11."]
