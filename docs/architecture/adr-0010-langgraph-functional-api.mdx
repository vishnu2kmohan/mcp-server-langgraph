...
icon: 'file-lines'
seoTitle: "ADR-0010: 10. LangGraph Functional API over Object-Oriented "
seoDescription: "Architecture Decision Record 0010: Architecture Decision Record: 10. LangGraph Functional API over Object-Oriented Approach"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "10."]
...
- Related ADRs: [ADR-0015](/architecture/adr-0015-memory-checkpointing), [ADR-0005](/architecture/adr-0005-pydantic-ai-integration)
