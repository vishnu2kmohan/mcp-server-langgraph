...
seoTitle: "23. Anthropic Tool Design Best Practices - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 23. Anthropic Tool Design Best Practices. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- [0004: MCP StreamableHTTP Transport](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0004-mcp-streamable-http.md)
- [0017: Error Handling Strategy](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0017-error-handling-strategy.md)
