...
seoTitle: "2. Fine-Grained Authorization with OpenFGA - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 2. Fine-Grained Authorization with OpenFGA. Category: Authentication & Authorization. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- [integrations/openfga-infisical.md](../integrations/openfga-infisical.mdx)
