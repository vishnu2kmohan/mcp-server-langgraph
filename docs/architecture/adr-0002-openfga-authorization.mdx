...
icon: 'file-lines'
seoTitle: "ADR-0002: 2. Fine-Grained Authorization with OpenFGA"
seoDescription: "Architecture Decision Record 0002: Architecture Decision Record: 2. Fine-Grained Authorization with OpenFGA"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "2."]
