---
title: 'ADR-0047: Visual Workflow Builder'
description: 'Architecture for visual LangGraph workflow design and code generation'
icon: 'diagram-project'
seoTitle: "ADR-0047: Visual Workflow Builder"
seoDescription: "Architecture Decision Record 0047: Architecture for visual LangGraph workflow design and code generation"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "ADR-0047"]
