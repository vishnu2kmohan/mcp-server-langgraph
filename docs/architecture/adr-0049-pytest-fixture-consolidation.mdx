...
description: 'Consolidation of duplicate autouse fixtures to improve test performance and maintainability'
icon: 'flask-vial'
seoTitle: "ADR-0049: Pytest Fixture Consolidation and Organization"
seoDescription: "Architecture Decision Record 0049: Consolidation of duplicate autouse fixtures to improve test performance and maintainability"
keywords: ["ADR", "architecture decision", "testing", "pytest", "fixtures", "TDD", "ADR-0049"]
