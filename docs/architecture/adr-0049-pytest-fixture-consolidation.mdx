...
seoTitle: "ADR-0049: Pytest Fixture Consolidation and Organization - Architecture Decision Record"
seoDescription: "Architecture Decision Record for ADR-0049: Pytest Fixture Consolidation and Organization. Category: Testing & Quality. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
