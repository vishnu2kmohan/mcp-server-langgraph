...
seoTitle: "37. Identity Federation Architecture - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 37. Identity Federation Architecture. Category: Authentication & Authorization. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
