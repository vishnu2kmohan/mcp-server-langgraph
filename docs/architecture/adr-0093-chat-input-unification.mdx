---
title: ADR-0093 Chat Input Component Unification
description: 'Consolidating duplicate chat input implementations into single source of truth'
icon: 'keyboard'
seoTitle: "ADR-0093: Chat Input Component Unification"
seoDescription: "Architecture Decision Record for unifying ChatInputForm and ChatDocument input implementations with feature flag rollback support."
keywords: ["chat input", "RichTextInput", "feature flag", "UI components", "unification", "ADR"]
