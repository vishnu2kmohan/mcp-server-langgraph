...
seoTitle: "3. Dual Observability: OpenTelemetry + LangSmith - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 3. Dual Observability: OpenTelemetry + LangSmith. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- [LangSmith Tracing Guide](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/docs/getting-started/langsmith-tracing.mdx)
- [Observability Overview](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/docs/guides/observability.mdx)
- Related Files: `observability.py`, `langsmith_src/mcp_server_langgraph/core/config.py`
- Related ADRs: [0001](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0001-llm-multi-provider.md) (LLM abstraction)
