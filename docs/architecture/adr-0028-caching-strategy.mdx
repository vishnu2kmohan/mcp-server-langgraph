...
description: 'Architecture Decision Record: 28. Multi-Layer Caching Strategy'
icon: 'memory'
contentType: "reference"
seoTitle: "28. Multi-Layer Caching Strategy - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 28. Multi-Layer Caching Strategy. Category: Performance & Resilience. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
# LLM response cache
"llm:response:model:claude-sonnet-4-5:hash:abc123def:v1"
