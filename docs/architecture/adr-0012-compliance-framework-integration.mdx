...
seoTitle: "12. Built-In Compliance Framework (GDPR, SOC 2, HIPAA) - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 12. Built-In Compliance Framework (GDPR, SOC 2, HIPAA). Category: Security & Compliance. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
