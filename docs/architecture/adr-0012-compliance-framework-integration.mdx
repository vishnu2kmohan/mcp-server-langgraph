...
icon: 'file-lines'
seoTitle: "ADR-0012: 12. Built-In Compliance Framework (GDPR, SOC 2, HI"
seoDescription: "Architecture Decision Record 0012: Architecture Decision Record: 12. Built-In Compliance Framework (GDPR, SOC 2, HIPAA)"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "12."]
