---
title: ADR-0074 AI Suggestions with Streaming and Cost Tracking
description: 'Unified AI suggestions system with streaming responses and LLM cost tracking'
icon: 'wand-magic-sparkles'
seoTitle: "ADR-0074: AI Suggestions with Streaming and Cost Tracking"
seoDescription: "Architecture Decision Record for implementing AI-powered workflow suggestions with streaming responses, cost tracking, and caching."
keywords: ["AI suggestions", "streaming", "cost tracking", "LLM", "caching", "ADR"]
...
**Related**: ADR-0027 (Rate Limiting), ADR-0028 (Caching), ADR-0043 (Cost Monitoring)
...
- [ADR-0028: Caching Strategy](./adr-0028-caching-strategy.mdx)
