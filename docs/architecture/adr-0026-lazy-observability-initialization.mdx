...
icon: 'file-lines'
seoTitle: "ADR-0026: 26. Lazy Observability Initialization"
seoDescription: "Architecture Decision Record 0026: Architecture Decision Record: ADR-0026: Lazy Observability Initialization"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "26."]
...
1. Revert to v2.7.0: `uv pip install mcp-server-langgraph==2.7.0`
