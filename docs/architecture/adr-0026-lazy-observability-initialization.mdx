---
title: "ADR-0026: Lazy Observability Initialization"
description: "Decouple observability bootstrapping from import time for container compatibility and library reusability"
---
...
- **Related ADRs**:
  - [ADR-0023: Anthropic Tool Design Best Practices](adr-0023-anthropic-tool-design-best-practices)
  - [ADR-0024: Agentic Loop Implementation](adr-0024-agentic-loop-implementation)
...
- **Timeline**: Implemented 2025-10-17
