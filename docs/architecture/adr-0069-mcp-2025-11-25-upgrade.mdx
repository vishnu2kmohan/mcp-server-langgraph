---
title: 'ADR-0069: MCP Specification Upgrade to 2025-11-25'
...
seoTitle: "ADR-0069: MCP Specification Upgrade to 2025-11-25"
seoDescription: "Architecture Decision Record for upgrading to MCP spec 2025-11-25 with Tasks, enhanced Sampling, and improved error handling."
keywords: ["MCP", "specification upgrade", "Tasks", "Sampling", "ADR"]
...
#### TypeScript Updates
- `studio/frontend/src/types/mcp.ts` - All new type definitions (migrated from playground)

<Note>
The standalone MCP Playground frontend was decommissioned in favor of the unified Agent Studio.
All MCP functionality is now available in the Studio frontend at `src/mcp_server_langgraph/studio/frontend/`.
</Note>
