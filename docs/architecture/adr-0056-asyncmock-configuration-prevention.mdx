---
title: 56. AsyncMock Configuration Prevention Mechanisms
description: 'Prevention mechanisms for AsyncMock configuration bugs in pytest-xdist parallel testing'
icon: 'file-lines'
seoTitle: "ADR-0056: AsyncMock Configuration Prevention Mechanisms"
seoDescription: "Architecture Decision Record 0056: Prevention mechanisms for AsyncMock configuration bugs in pytest-xdist parallel testing"
keywords: ["ADR", "architecture decision", "testing", "asyncmock", "pytest-xdist", "security"]
contentType: "explanation"
---

## ADR-0056: AsyncMock Configuration Prevention Mechanisms
