...
icon: 'file-lines'
seoTitle: "ADR-0032: 32. JWT Standardization Across All Authentication "
seoDescription: "Architecture Decision Record 0032: Authentication systems often support multiple token formats (sessions, cookies, opaque tokens, JWTs, API keys) leading to complexity in vali"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "32."]
...
- Related ADRs: [ADR-0007](/architecture/adr-0007-authentication-provider-pattern), [ADR-0031](/architecture/adr-0031-keycloak-authoritative-identity), [ADR-0034](/architecture/adr-0034-api-key-jwt-exchange), [ADR-0035](/architecture/adr-0035-kong-jwt-validation), [ADR-0036](/architecture/adr-0036-hybrid-session-model)
