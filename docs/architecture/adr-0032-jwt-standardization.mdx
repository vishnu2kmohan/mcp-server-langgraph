...
description: 'Architecture Decision Record: 32. JWT Standardization Across All Authentication Flows'
icon: 'key'
contentType: "reference"
seoTitle: "32. JWT Standardization Across All Authentication Flows - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 32. JWT Standardization Across All Authentication Flows. Category: Authentication & Authorization. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- Related ADRs: [ADR-0007](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0007-authentication-provider-pattern.md), [ADR-0031](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0031-keycloak-authoritative-identity.md), [ADR-0034](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0034-api-key-jwt-exchange.md), [ADR-0035](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0035-kong-jwt-validation.md), [ADR-0036](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0036-hybrid-session-model.md)
