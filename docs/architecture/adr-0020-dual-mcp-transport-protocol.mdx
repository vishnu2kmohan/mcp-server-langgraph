...
seoTitle: "20. Dual MCP Transport Protocol (STDIO + StreamableHTTP) - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 20. Dual MCP Transport Protocol (STDIO + StreamableHTTP). Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
