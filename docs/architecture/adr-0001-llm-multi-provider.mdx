...
icon: 'file-lines'
seoTitle: "ADR-0001: 1. Multi-Provider LLM Support via LiteLLM"
seoDescription: "Architecture Decision Record 0001: Architecture Decision Record: 1. Multi-Provider LLM Support via LiteLLM"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "1."]
