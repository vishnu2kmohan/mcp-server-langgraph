...
seoTitle: "1. Multi-Provider LLM Support via LiteLLM - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 1. Multi-Provider LLM Support via LiteLLM. Category: Core Architecture. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- [integrations/litellm.md](../integrations/litellm.mdx)
