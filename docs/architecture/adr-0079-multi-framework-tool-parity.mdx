...
flowchart LR
    ...
    classDef registryStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
    classDef frameworkStyle fill:#bebada,stroke:#7e5eb0,stroke-width:2px,color:#333

    class IMPL devStyle
    class REG,ADAPT registryStyle
    class LC,CS,MCP frameworkStyle
```
