...
icon: 'file-lines'
seoTitle: "ADR-0004: 4. MCP StreamableHTTP Transport Protocol"
seoDescription: "Architecture Decision Record 0004: Architecture Decision Record: 4. MCP StreamableHTTP Transport Protocol"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "4."]
