---
title: ADR-0088 Frontend Hook Selection Guidance
description: 'Selection criteria and guidelines for choosing the right React hooks in Agent Studio frontend'
icon: 'code-branch'
seoTitle: "ADR-0088: Frontend Hook Selection Guidance"
seoDescription: "Architecture Decision Record for React hook selection criteria, deprecation policy, and AI integration patterns in Agent Studio frontend."
keywords: ["hooks", "React", "frontend", "Agent Studio", "AI integration", "state management", "ADR"]
...
**Supersedes**: None
**Related**: [ADR-0084 Studio Orchestrator Unified AI](./adr-0084-studio-orchestrator-unified-ai.mdx), [ADR-0085 Feature Flag Consolidation](./adr-0085-feature-flag-consolidation.mdx)
