...
seoTitle: "34. API Key to JWT Exchange Pattern - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 34. API Key to JWT Exchange Pattern. Category: Authentication & Authorization. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
