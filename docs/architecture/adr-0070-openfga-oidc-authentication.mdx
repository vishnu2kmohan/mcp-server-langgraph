---
title: ADR-0070 OpenFGA OIDC Authentication
description: 'Migrate OpenFGA from preshared key to OIDC authentication using OAuth 2.0 Client Credentials Grant'
icon: 'shield-halved'
seoTitle: "ADR-0070: OpenFGA OIDC Authentication Migration"
seoDescription: "Architecture Decision Record for migrating OpenFGA authentication from preshared keys to OIDC using OAuth 2.0 Client Credentials Grant for improved security."
keywords: ["OpenFGA", "OIDC", "OAuth 2.0", "authentication", "Client Credentials Grant", "ADR"]
