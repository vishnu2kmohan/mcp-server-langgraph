---
title: "60. Database Architecture and Naming Convention"
description: 'Architecture Decision Record: 60. Database Architecture and Naming Convention'
icon: 'database'
contentType: "reference"
seoTitle: "60. Database Architecture and Naming Convention - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 60. Database Architecture and Naming Convention. Category: Data & Storage. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
| Service | Development | Test | STG | Production |
|---------|-------------|------|---------|------------|
...
- No suffix in prod/stg keeps database names simple
...
**✅ Consistency**: Same database structure across dev/test/stg/prod
...
- [ ] Update Helm values for production/stg with database configuration
...
- [ADR-0006](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0006-session-storage-architecture.md) - Session storage (may use PostgreSQL in future)
- [ADR-0002](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0002-openfga-authorization.md) - OpenFGA authorization database
- [ADR-0007](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0007-authentication-provider-pattern.md) - Keycloak authentication database
- [ADR-0030](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0030-resilience-patterns.md) - Circuit breakers for database connections
