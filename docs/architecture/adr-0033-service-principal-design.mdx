...
description: 'Architecture Decision Record: 33. Service Principal Design and Authentication Modes'
icon: 'user-gear'
contentType: "reference"
seoTitle: "33. Service Principal Design and Authentication Modes - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 33. Service Principal Design and Authentication Modes. Category: Authentication & Authorization. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
