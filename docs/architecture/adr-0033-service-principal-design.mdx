---
title: 33. Service Principal Design and Authentication Modes
description: 'Machine-to-machine authentication, batch jobs, streaming tasks, and background processes require persistent identity and long-lived credentials tha...'
icon: 'file-lines'
seoTitle: "ADR-0033: 33. Service Principal Design and Authentication Mo"
seoDescription: "Architecture Decision Record 0033: Machine-to-machine authentication, batch jobs, streaming tasks, and background processes require persistent identity and long-lived credenti"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "33."]
...
- Related ADRs: [ADR-0031](/architecture/adr-0031-keycloak-authoritative-identity), [ADR-0032](/architecture/adr-0032-jwt-standardization), [ADR-0036](/architecture/adr-0036-hybrid-session-model), [ADR-0039](/architecture/adr-0039-openfga-permission-inheritance)
