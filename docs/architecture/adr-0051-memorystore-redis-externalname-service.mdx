...
description: 'Architecture Decision Record documenting the decision to use Kubernetes ExternalName Service + Google Cloud DNS to reference Memorystore Redis instances'
icon: 'cloud'
---
