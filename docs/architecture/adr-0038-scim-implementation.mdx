...
icon: 'file-lines'
seoTitle: "ADR-0038: 38. SCIM 2.0 Implementation Approach"
seoDescription: "Architecture Decision Record 0038: External identity management systems (Azure AD, Okta, Google Workspace, OneLogin) need to programmatically provision/deprovision users and g"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "38."]
...
- Related ADRs: [ADR-0031](/architecture/adr-0031-keycloak-authoritative-identity)
