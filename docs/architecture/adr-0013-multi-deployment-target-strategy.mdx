...
icon: 'file-lines'
seoTitle: "ADR-0013: 13. Multi-Deployment Target Strategy"
seoDescription: "Architecture Decision Record 0013: Architecture Decision Record: 13. Multi-Deployment Target Strategy"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "13."]
