...
seoTitle: "13. Multi-Deployment Target Strategy - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 13. Multi-Deployment Target Strategy. Category: Infrastructure & Deployment. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
