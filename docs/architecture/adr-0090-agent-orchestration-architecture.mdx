---
title: ADR-0090 Agent Orchestration Architecture
description: 'Comprehensive agent orchestration with RouterAgent, SwarmOrchestrator, and execution plan workflows'
icon: 'sitemap'
seoTitle: "ADR-0090: Agent Orchestration Architecture"
seoDescription: "Architecture Decision Record for multi-agent orchestration including RouterAgent, SwarmOrchestrator, ExecutionPlan approval workflows, and semantic template matching."
keywords: ["orchestration", "multi-agent", "RouterAgent", "SwarmOrchestrator", "execution plans", "HITL", "ADR"]
...
- [ADR-0078](./adr-0078-multi-agent-orchestrator-patterns.mdx): Base orchestrator patterns
- [ADR-0081](./adr-0081-handoff-pattern-multi-agent.mdx): Handoff pattern
- [ADR-0083](./adr-0083-confidence-based-hitl-system.mdx): HITL system
- [ADR-0089](./adr-0089-prompt-architecture-centralization.mdx): Prompt architecture
