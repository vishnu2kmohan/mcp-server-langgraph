---
title: "65. Ruff for Code Quality"
description: 'Architecture Decision Record: 65. Ruff for Code Quality'
icon: 'broom'
contentType: "reference"
seoTitle: "65. Ruff for Code Quality - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 65. Ruff for Code Quality. Category: Development & Tooling. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
- Related ADRs: [ADR-0064](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0064-pre-commit-hooks-strategy.md), [ADR-0062](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/adr/adr-0062-uv-package-management.md)
