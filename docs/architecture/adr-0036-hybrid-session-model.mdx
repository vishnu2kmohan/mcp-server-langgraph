...
icon: 'file-lines'
seoTitle: "ADR-0036: 36. Hybrid Session Model for Long-Running Tasks"
seoDescription: "Architecture Decision Record 0036: JWT-based authentication (ADR-0032) uses short-lived access tokens (15 minutes) for security, but this conflicts with long-running tasks:"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "36."]
...
sequenceDiagram
    ...
    loop Every API Request
        ...
        alt Access token expires in less than 5 min
