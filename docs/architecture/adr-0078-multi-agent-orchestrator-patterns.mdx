...
icon: 'robot'
seoTitle: "ADR-0078: Multi-Agent Orchestrator Patterns"
seoDescription: "Architecture Decision Record for implementing parallel execution orchestrators for AI UX enhancements and alert analysis workflows."
keywords: ["multi-agent", "orchestrator", "parallel execution", "AI UX", "ADR"]
...
flowchart TD
    ...
    classDef taskStyle fill:#8dd3c7,stroke:#2a9d8f,stroke-width:2px,color:#333
    classDef gatherStyle fill:#ffffb3,stroke:#f1c40f,stroke-width:2px,color:#333
    ...
    classDef finalStyle fill:#fdb462,stroke:#e67e22,stroke-width:2px,color:#333
