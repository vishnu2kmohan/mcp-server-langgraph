---
title: "99. Semantic Tool Selection for Dynamic Capability Discovery"
description: 'Architecture Decision Record: Semantic Tool Selection for Dynamic Capability Discovery'
icon: 'code'
