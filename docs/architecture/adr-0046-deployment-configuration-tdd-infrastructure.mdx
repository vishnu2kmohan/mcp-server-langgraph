---
title: "46. Deployment Configuration TDD Infrastructure"
description: 'Architecture Decision Record: 46. Deployment Configuration TDD Infrastructure'
icon: 'rocket'
contentType: "reference"
seoTitle: "46. Deployment Configuration TDD Infrastructure - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 46. Deployment Configuration TDD Infrastructure. Category: Testing & Quality. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
...
2. **validate-kustomize**: Matrix build across 5 overlays (dev, stg, production, stg-gke, prod-gke)
...
2. **ExternalSecrets Integration Tests**: Test secret sync in stg
