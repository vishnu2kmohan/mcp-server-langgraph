...
icon: 'file-lines'
seoTitle: "ADR-0018: 18. Semantic Versioning Strategy"
seoDescription: "Architecture Decision Record 0018: Architecture Decision Record: 18. Semantic Versioning Strategy"
keywords: ["ADR", "architecture decision", "design pattern", "MCP Server architecture", "18."]
...
```markdown
[![Version](https://img.shields.io/badge/version-2.2.0-blue.svg)](https://github.com/vishnu2kmohan/mcp-server-langgraph/blob/main/CHANGELOG.md)
```
