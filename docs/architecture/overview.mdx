...
We maintain **30 ADRs** organized into six categories:
...
graph TB
    ...
    classDef transportStyle fill:#d95f02,stroke:#a64801,stroke-width:2px,color:#fff
    classDef securityStyle fill:#7570b3,stroke:#4e4a7f,stroke-width:2px,color:#fff
