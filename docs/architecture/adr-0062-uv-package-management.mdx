...
seoTitle: "62. uv for Package Management - Architecture Decision Record"
seoDescription: "Architecture Decision Record for 62. uv for Package Management. Category: Development & Tooling. Part of MCP Server with LangGraph documentation."
keywords:
  - "architecture"
  - "decision"
  - "record"
