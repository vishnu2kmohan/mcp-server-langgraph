---
title: 'ADR-0050: Dependency Singleton Pattern Justification'
description: Architecture Decision Record documenting the decision to maintain module-level
  singleton pattern for dependency injection
icon: gear
contentType: explanation
seoTitle: 'ADR-0050: Dependency Singleton... - MCP Server LangGraph'
seoDescription: Architecture Decision Record documenting the decision to maintain
  module-level singleton pattern for dependency injection Learn more about MCP Server
  LangGraph.
keywords:
- adr-0050
- dependency
...
* [ADR-0042: Dependency Injection Configuration Fixes](/architecture/adr-0042-dependency-injection-configuration-fixes) - Fixed critical bugs in dependency initialization
* [ADR-0049: Pytest Fixture Consolidation](/architecture/adr-0049-pytest-fixture-consolidation) - Consolidated duplicate fixtures for better test organization
