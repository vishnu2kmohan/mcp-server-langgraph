...
###############################################################################
# STG GKE Deployment Validation Script
#
# This script performs comprehensive validation of the stg GKE deployment,
...
#
# Usage:
#   ./scripts/gcp/validate-stg-deployment.sh [OPTIONS]
#
# Options:
...
# Resource names match Terraform naming convention (short_prefix = "stg-mcp-slg")
...
validate_infrastructure() {
    ...
    if [ "$alert_count" -gt 0 ]; then
        ...
        record_test_warn "Monitoring policies" "No stg alert policies found"
    fi
...
main() {
    log_info "Starting stg GKE deployment validation..."
