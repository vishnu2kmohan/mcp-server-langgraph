...
manifest_files = [
    "deployments/overlays/prod-gke/deployment-patch.yaml",
    "deployments/overlays/prod-gke/keycloak-patch.yaml",
    "deployments/overlays/prod-gke/openfga-patch.yaml",
    "deployments/overlays/prod/deployment-patch.yaml",
    "deployments/overlays/prod/otel-collector-patch.yaml",
    "deployments/overlays/prod/postgres-patch.yaml",
    "deployments/overlays/prod/qdrant-patch.yaml",
    "deployments/overlays/prod/redis-session-patch.yaml",
    "deployments/overlays/stg-gke/keycloak-patch.yaml",
    "deployments/overlays/stg-gke/otel-collector-patch.yaml",
    "deployments/overlays/stg/deployment-patch.yaml",
    "deployments/overlays/stg/otel-collector-patch.yaml",
