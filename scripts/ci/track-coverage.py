...
def main():
    ...
    parser.add_argument('--history-dir', default='.coverage-history',
                        help='Directory to store coverage history (default: .coverage-history)')
    parser.add_argument('--fail-threshold', type=float, default=5.0,
                        help='Fail if coverage drops by more than this percentage (default: 5.0)')
