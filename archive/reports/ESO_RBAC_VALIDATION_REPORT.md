...
The infrastructure script (`scripts/gcp/setup-stg-infrastructure.sh`) is **already correct**:
...
- Infrastructure Script: `scripts/gcp/setup-stg-infrastructure.sh`
- Test Suite: `tests/infrastructure/test_external_secrets_rbac.py`
...
- Deployment Manifests: `deployments/overlays/stg-gke/external-secrets.yaml`
