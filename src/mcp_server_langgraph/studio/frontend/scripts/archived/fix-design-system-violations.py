...
from typing import Any, Pattern, Match, Callable
...
NEUTRAL_MAP = {
    "50": "1", "100": "2", "200": "3", "300": "5",
    "400": "9", "500": "10", "600": "11", "700": "11",
    "800": "12", "900": "12", "950": "12",
}
...
SPACING_MAP = {
    ...
    "1.5rem": "6", "1.75rem": "7", "2rem": "8", "2.25rem": "9", "2.5rem": "10",
    "2.75rem": "11", "3rem": "12", "3.5rem": "14", "4rem": "16", "5rem": "20",
    "6rem": "24", "7rem": "28", "8rem": "32", "9rem": "36", "10rem": "40",
}
...
ANIMATION_MAP = {
    # ms to token
    "75ms": "75", "100ms": "100", "150ms": "150", "200ms": "200",
    "300ms": "300", "500ms": "500", "700ms": "700", "1000ms": "1000",
    # s to token (convert to ms)
    "0.075s": "75", "0.1s": "100", "0.15s": "150", "0.2s": "200",
    "0.3s": "300", "0.5s": "500", "0.7s": "700", "1s": "1000",
}
...
BORDER_RADIUS_MAP = {
    # px to token
    "0px": "none", "1px": "sm", "2px": "sm",
    "3px": "DEFAULT", "4px": "DEFAULT",
    "5px": "md", "6px": "md",
    "7px": "lg", "8px": "lg",
    "10px": "xl", "12px": "xl",
    "14px": "2xl", "16px": "2xl",
    "20px": "3xl", "24px": "3xl",
    # rem to token
    "0.125rem": "sm", "0.25rem": "DEFAULT", "0.375rem": "md",
...
def build_border_radius_replacements() -> list[tuple[re.Pattern[str], str]]:
    ...
    replacements = []
    prefixes = ["rounded", "rounded-t", "rounded-r", "rounded-b", "rounded-l",
...
OPACITY_MAP = {
    ...
    # Short decimals
    ".05": "5", ".1": "10", ".2": "20", ".25": "25", ".3": "30",
    ".4": "40", ".5": "50", ".6": "60", ".7": "70", ".75": "75",
    ".8": "80", ".9": "90", ".95": "95",
}
...
def get_files(extensions: list[str]) -> list[Path]:
    ...
    for ext in extensions:
        files.extend([
            f for f in src_dir.rglob(f"*.{ext}")
