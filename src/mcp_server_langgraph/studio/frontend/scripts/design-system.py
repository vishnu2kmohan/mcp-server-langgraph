...
from typing import Any, Callable, Iterator, Match, Pattern
...
LEGACY_TO_RADIX = {
    ...
    "500": "9", "600": "10", "700": "11", "800": "11", "900": "12", "950": "12",
}
...
def _build_patterns() -> list[ViolationPattern]:
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r'\b(?:stroke|fill|color|backgroundColor|bgColor|textColor|borderColor|nodeColor|maskColor)\s*=\s*["{]["\']?#[0-9a-fA-F]{3,8}'),
        category=Category.COLOR,
        severity=Severity.ERROR,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r'\b(?:stroke|fill|color|backgroundColor|bgColor|textColor|borderColor|nodeColor|maskColor)\s*=\s*["\'`]rgba?\([^)]+\)'),
        category=Category.COLOR,
        severity=Severity.ERROR,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r'\b(?:stroke|fill|color|backgroundColor|bgColor|textColor|borderColor|nodeColor|maskColor)\s*=\s*["\'`]hsla?\([^)]+\)'),
        category=Category.COLOR,
        severity=Severity.ERROR,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(rf'\b(?:stroke|fill|backgroundColor|bgColor|textColor|borderColor|nodeColor|maskColor)="(?:{NAMED_COLORS})"'),
        category=Category.COLOR,
        severity=Severity.ERROR,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r"\b(?:bg|text|border|ring|divide|outline|fill|stroke)-(?:neutral|primary|error|success|warning|info|insight)-\d{1,2}/\d+"),
        category=Category.COLOR,
        severity=Severity.WARNING,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r"\bdark:(?:bg|text|border|ring|divide|outline|fill|stroke)-(?:neutral|primary|error|success|warning|info|insight)-\d{1,2}/\d+"),
        category=Category.COLOR,
        severity=Severity.ERROR,
    ...
    patterns.append(ViolationPattern(
        regex=re.compile(r'className=[^>]*(?<![\-])progress(?!-(?:fill|bar-fill|Color))[^>]*(?<!role=["\']progressbar["\'])'),
        category=Category.ARIA,
        severity=Severity.INFO,
