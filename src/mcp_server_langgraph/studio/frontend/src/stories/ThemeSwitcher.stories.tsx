  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 flex-wrap">
        <span className="px-2 py-1 text-xs bg-success-3 text-success-11 rounded-full">
          Success
        </span>
        <span className="px-2 py-1 text-xs bg-warning-3 text-warning-11 rounded-full">
          Warning
        </span>
        <span className="px-2 py-1 text-xs bg-error-3 text-error-11 rounded-full">
          Error
        </span>
        <span className="px-2 py-1 text-xs bg-info-3 text-info-11 rounded-full">
          Info
        </span>
        <span className="px-2 py-1 text-xs bg-insight-3 text-insight-11 rounded-full">
          AI Insight
        </span>
      </div>
        ...
        >
          ...
          <div className="p-4 bg-neutral-1 space-y-3">
            <div className="flex gap-2">
              ...
              <div
                className="w-8 h-8 rounded"
                style={{ backgroundColor: "var(--sage-6)" }}
              />
            </div>
            <p className="text-sm text-neutral-11">
              AI-native, innovation, purple-green harmony
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="p-4 bg-neutral-1 space-y-3">
            <div className="flex gap-2">
              <div
                className="w-8 h-8 rounded"
                style={{ backgroundColor: "var(--teal-9)" }}
              />
              <div
                className="w-8 h-8 rounded"
                style={{ backgroundColor: "var(--sage-6)" }}
            ...
            <p className="text-sm text-neutral-11">
              Solarized-inspired, terminal classic
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="p-4 bg-neutral-1 space-y-3">
            <div className="flex gap-2">
              ...
              <div
                className="w-8 h-8 rounded"
                style={{ backgroundColor: "var(--olive-6)" }}
              />
            </div>
...
function CSSVariablesReference() {
  const semanticColors = [
    {
      name: "primary",
      description: "Primary accent (Violet/Teal based on theme)",
    },
  ...
  return (
    <div className="space-y-8 p-6">
      <div>
        ...
        <p className="text-neutral-11">
          Semantic color variables that automatically adapt to the selected
          theme.
        </p>
      </div>
          ...
          <tbody>
            {semanticColors.map((color) => (
              <tr key={color.name} className="border-b border-neutral-6">
                <td className="py-3 px-4 font-medium text-neutral-12 capitalize">
                  {color.name}
                </td>
                <td className="py-3 px-4">
                  <code className="text-xs text-neutral-11">
                    --{color.name}-1 to --{color.name}-12
                  </code>
                </td>
      ...
      <div className="bg-neutral-2 border border-neutral-6 rounded-lg p-4 font-mono text-xs">
        ...
        <p className="text-neutral-12">
          {'<button class="bg-primary-9 text-neutral-12">Click me</button>'}
        </p>
      </div>
    </div>
  );
