...
describe("PlanSearch", () => {
  ...
  describe("Template Selection", () => {
    ...
    it("should highlight selected template", () => {
      render(
        <TestProvider>
          <PlanSearch {...defaultProps} selectedTemplateId="tmpl-1" />
        </TestProvider>,
      );
  ...
  describe("Loading State", () => {
    it("should show loading indicator when isLoading is true", () => {
      render(
        <TestProvider>
          <PlanSearch {...defaultProps} isLoading={true} />
        </TestProvider>,
      );
  ...
  describe("Empty State", () => {
    it("should show empty state when no templates match", () => {
      render(
        <TestProvider>
          <PlanSearch {...defaultProps} templates={[]} />
        </TestProvider>,
      );
  ...
  describe("Error State", () => {
    it("should display error message when error prop is provided", () => {
      render(
        <TestProvider>
          <PlanSearch {...defaultProps} error="Failed to load templates" />
        </TestProvider>,
      );
