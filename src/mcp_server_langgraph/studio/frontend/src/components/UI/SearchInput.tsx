      ...
      <div className="absolute left-3 pointer-events-none">
        {isLoading ? (
          ...
          <div data-testid="search-icon">
            <Search className="w-4 h-4 text-neutral-9" />
          </div>
        )}
      </div>
      <input
        ...
        className="
          ...
          border border-neutral-5 rounded-lg
          bg-neutral-1
          text-neutral-12
          placeholder-neutral-9
          focus:outline-none focus:ring-2 focus:ring-primary-7 focus:border-transparent
        "
      />
      {localValue && (
        <Button
