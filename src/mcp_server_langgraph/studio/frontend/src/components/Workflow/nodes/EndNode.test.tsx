...
describe("EndNode", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should display CircleStop icon", () => {
      ...
      const icons = document.querySelectorAll("svg.text-error-9");
  ...
  describe("Status Visualization", () => {
    ...
    it("should show success status with check icon", () => {
      ...
      const checkIcon = document.querySelector("svg.text-success-9");
    ...
    it("should show error status with X icon", () => {
      ...
      const xIcon = document.querySelector("svg.text-error-9");
  ...
  describe("Icon Styling", () => {
    it("should have red CircleStop icon", () => {
      ...
      // CircleStop icon has text-error-9 class for styling
      const icons = document.querySelectorAll("svg.text-error-9");
