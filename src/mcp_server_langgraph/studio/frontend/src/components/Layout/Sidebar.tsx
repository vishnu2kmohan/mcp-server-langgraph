        ...
        >
          {isCollapsed ? (
            ...
            <div className="space-y-3">
              ...
              {/* Actions row - evenly distributed buttons */}
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 flex justify-center">
                  <button
                    onClick={handleThemeToggle}
                    className="p-2 text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                    aria-label={
                      isDarkMode
                ...
                <div className="flex-1 flex justify-center">
                  <button
                    onClick={handleLogout}
                    disabled={isLoggingOut}
                    className="p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-lg transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500 disabled:opacity-50 disabled:cursor-not-allowed"
                    aria-label={isLoggingOut ? "Signing out..." : "Sign out"}
                    title={isLoggingOut ? "Signing out..." : "Sign out"}
                  >
                    {isLoggingOut ? (
