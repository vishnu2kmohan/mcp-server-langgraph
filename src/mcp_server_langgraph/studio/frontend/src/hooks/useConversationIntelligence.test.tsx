...
// Mock only the specific export used by useConversationIntelligence.
// NEVER vi.importActual("../api") — the barrel is 5,132 lines and causes OOM in fork workers.
const mockAnalyzeTrigger = vi.fn(() => ({
  unwrap: () =>
    Promise.resolve({
      analyses: {
        intent_detect: {
...
const mockAnalyzeReturn = [mockAnalyzeTrigger, { isLoading: false }] as const;

vi.mock("../api", () => ({
  useStudioAnalyzeMutation: vi.fn(() => mockAnalyzeReturn),
}));
// =============================================================================
// Test Utilities
// =============================================================================
