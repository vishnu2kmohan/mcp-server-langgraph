...
# =============================================================================
# DEPRECATED WebSocket Endpoints (Removed in v4.0)
# =============================================================================
# The following endpoints have been migrated to the consolidated ws_router:
#   /mcp/ws        -> /api/v1/ws/mcp (ws_router.py)
#   /mcp/ws/auth   -> /api/v1/ws/mcp/auth (ws_router.py)
#   /mcp/ws/{id}   -> /api/v1/ws/mcp/{session_id} (ws_router.py)
#
# Clients should update to use the new /api/v1/ws/* URLs.
# See: src/mcp_server_langgraph/websocket/README.md for migration guide.
# =============================================================================
