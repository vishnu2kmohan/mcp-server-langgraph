...
# Import AIExplanation for Pydantic field type annotation (runtime required)
...
class ApprovalRequired(BaseModel):
    ...
    AI-Native Enhancement (Phase 1):
        Optional ai_explanation field contains AI-generated context about
        why the agent is uncertain, what could go wrong, and safer alternatives.
        Generated by ExplanationOrchestrator using parallel analysis agents.
    """
    ...
    ai_explanation: AIExplanation | None = Field(
        default=None,
        description="AI-generated explanation for HITL dialog (Phase 1 AI-Native Enhancement)",
    )
