    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      >
        <div className="p-6">
          ...
          {/* URL Mode (SEP-1036): Show "Open URL" button for OAuth flows */}
          {elicitation.mode === 'url' && elicitation.url && (
            <div className="mb-6">
              <p className="text-sm text-gray-600 dark:text-dark-textSecondary mb-3">
                This request requires you to complete authentication in a browser window.
              </p>
              <a
          ...
          {/* Schema Form (only for inline mode) */}
