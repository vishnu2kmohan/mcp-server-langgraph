/**
 * Unified Design Tokens for MCP Server LangGraph
 *
 * Shared design system constants for consistent styling across:
 * - Visual Workflow Builder
 * - Interactive Playground
 *
 * Based on Tailwind CSS with semantic extensions.
 *
 * @module @mcp-server-langgraph/shared-frontend/styles
 */
...
export const colors = {
  ...
  // Primary color scale (from Playground - Sky blue)
  primary: {
    50: '#f0f9ff',
    100: '#e0f2fe',
    200: '#bae6fd',
  ...
  // Node Type Colors (from Builder - for workflow canvas)
  nodes: {
    tool: '#3b82f6', // Blue
    llm: '#8b5cf6', // Purple
  ...
  // Dark mode specific (unified naming from Playground)
  dark: {
    bg: '#0f172a',
    surface: '#1e293b',
    surfaceHover: '#334155',
  ...
  // Light mode specific (unified naming from Playground)
  light: {
    bg: '#ffffff',
    surface: '#f9fafb',
    surfaceHover: '#f3f4f6',
...
export const transitions = {
  ...
  // Duration values (for Builder compatibility)
  duration: {
    fast: '150ms',
    DEFAULT: '200ms',
    slow: '300ms',
  ...
  // Easing values (for Builder compatibility)
  easing: {
...
// =============================================================================
// Z-Index (unified to Playground's 0-80 scale)
// =============================================================================
...
export const layout = {
  ...
  // Panel widths (from Playground)
  sessionPanelWidth: '320px',
  observabilityPanelWidth: '400px',
  chatMinWidth: '400px',

  // Builder-specific
  nodePaletteWidth: '240px',
  codeEditorMinWidth: '400px',
} as const;
...
export const components = {
  ...
  input: {
    ...
    placeholder: colors.light.textMuted,
  ...
  // Trace span colors (from Playground)
  trace: {
  ...
  // Toast notifications (from Builder)
  toast: {
...
export const cssVariables = `
  :root {
    ...
    --color-surface-hover: ${colors.light.surfaceHover};
  ...
  .dark {
    ...
    --color-surface-hover: ${colors.dark.surfaceHover};
