...
| ci.yaml | 3 | ~8 |
| release.yaml | 2 | ~6 |
| deploy-stg-gke.yaml | 1 | ~2 |
| deploy-prod-gke.yaml | 1 | ~2 |
...
11. `.github/workflows/deploy-stg-gke.yaml` - 1 job
12. `.github/workflows/deploy-prod-gke.yaml` - 1 job
...
- **Workflows affected**:
  1. deploy-prod-gke.yaml (4 instances)
  2. deploy-stg-gke.yaml (4 instances)
