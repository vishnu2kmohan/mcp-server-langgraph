...
- **File**: `deployments/overlays/stg-gke/otel-collector-patch.yaml`
...
- **File**: `deployments/overlays/stg-gke/cloud-sql-proxy-patch.yaml`
...
- **File**: `deployments/overlays/stg-gke/otel-collector-configmap-patch.yaml`
...
# Edit: deployments/overlays/stg-gke/otel-collector-patch.yaml
...
# Edit: deployments/overlays/stg-gke/keycloak-patch.yaml
...
kustomize build deployments/overlays/stg-gke/ | kubectl apply --dry-run=client -f -
kustomize build deployments/overlays/prod-gke/ | kubectl apply --dry-run=client -f -
```
...
**Overlay Files**:
- `/home/vishnu/git/vishnu2kmohan/worktrees/mcp-server-langgraph-session-20251116-105811/deployments/overlays/stg-gke/keycloak-patch.yaml` (1 issue)
- `/home/vishnu/git/vishnu2kmohan/worktrees/mcp-server-langgraph-session-20251116-105811/deployments/overlays/stg-gke/otel-collector-patch.yaml` (1 issue)
- `/home/vishnu/git/vishnu2kmohan/worktrees/mcp-server-langgraph-session-20251116-105811/deployments/overlays/stg-gke/network-policy.yaml` (1 issue)
